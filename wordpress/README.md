...
-	[`5.5.1-php7.2-apache`, `5.5-php7.2-apache`, `5-php7.2-apache`, `php7.2-apache`, `5.5.1-php7.2`, `5.5-php7.2`, `5-php7.2`, `php7.2`](https://github.com/docker-library/wordpress/blob/1de7b5a2f3423908c9c46e21e143f4d3b5a763fe/php7.2/apache/Dockerfile)
-	[`5.5.1-php7.2-fpm`, `5.5-php7.2-fpm`, `5-php7.2-fpm`, `php7.2-fpm`](https://github.com/docker-library/wordpress/blob/1de7b5a2f3423908c9c46e21e143f4d3b5a763fe/php7.2/fpm/Dockerfile)
-	[`5.5.1-php7.2-fpm-alpine`, `5.5-php7.2-fpm-alpine`, `5-php7.2-fpm-alpine`, `php7.2-fpm-alpine`](https://github.com/docker-library/wordpress/blob/1de7b5a2f3423908c9c46e21e143f4d3b5a763fe/php7.2/fpm-alpine/Dockerfile)
-	[`5.5.1-php7.3-apache`, `5.5-php7.3-apache`, `5-php7.3-apache`, `php7.3-apache`, `5.5.1-php7.3`, `5.5-php7.3`, `5-php7.3`, `php7.3`](https://github.com/docker-library/wordpress/blob/1de7b5a2f3423908c9c46e21e143f4d3b5a763fe/php7.3/apache/Dockerfile)
-	[`5.5.1-php7.3-fpm`, `5.5-php7.3-fpm`, `5-php7.3-fpm`, `php7.3-fpm`](https://github.com/docker-library/wordpress/blob/1de7b5a2f3423908c9c46e21e143f4d3b5a763fe/php7.3/fpm/Dockerfile)
-	[`5.5.1-php7.3-fpm-alpine`, `5.5-php7.3-fpm-alpine`, `5-php7.3-fpm-alpine`, `php7.3-fpm-alpine`](https://github.com/docker-library/wordpress/blob/1de7b5a2f3423908c9c46e21e143f4d3b5a763fe/php7.3/fpm-alpine/Dockerfile)
-	[`5.5.1-apache`, `5.5-apache`, `5-apache`, `apache`, `5.5.1`, `5.5`, `5`, `latest`, `5.5.1-php7.4-apache`, `5.5-php7.4-apache`, `5-php7.4-apache`, `php7.4-apache`, `5.5.1-php7.4`, `5.5-php7.4`, `5-php7.4`, `php7.4`](https://github.com/docker-library/wordpress/blob/1de7b5a2f3423908c9c46e21e143f4d3b5a763fe/php7.4/apache/Dockerfile)
-	[`5.5.1-fpm`, `5.5-fpm`, `5-fpm`, `fpm`, `5.5.1-php7.4-fpm`, `5.5-php7.4-fpm`, `5-php7.4-fpm`, `php7.4-fpm`](https://github.com/docker-library/wordpress/blob/1de7b5a2f3423908c9c46e21e143f4d3b5a763fe/php7.4/fpm/Dockerfile)
-	[`5.5.1-fpm-alpine`, `5.5-fpm-alpine`, `5-fpm-alpine`, `fpm-alpine`, `5.5.1-php7.4-fpm-alpine`, `5.5-php7.4-fpm-alpine`, `5-php7.4-fpm-alpine`, `php7.4-fpm-alpine`](https://github.com/docker-library/wordpress/blob/1de7b5a2f3423908c9c46e21e143f4d3b5a763fe/php7.4/fpm-alpine/Dockerfile)
