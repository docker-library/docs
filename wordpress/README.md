...
-	[`5.9.1-apache`, `5.9-apache`, `5-apache`, `apache`, `5.9.1`, `5.9`, `5`, `latest`, `5.9.1-php7.4-apache`, `5.9-php7.4-apache`, `5-php7.4-apache`, `php7.4-apache`, `5.9.1-php7.4`, `5.9-php7.4`, `5-php7.4`, `php7.4`](https://github.com/docker-library/wordpress/blob/8874538f8ac8e2adc0beac9ab5e637a823addf3b/latest/php7.4/apache/Dockerfile)
-	[`5.9.1-fpm`, `5.9-fpm`, `5-fpm`, `fpm`, `5.9.1-php7.4-fpm`, `5.9-php7.4-fpm`, `5-php7.4-fpm`, `php7.4-fpm`](https://github.com/docker-library/wordpress/blob/8874538f8ac8e2adc0beac9ab5e637a823addf3b/latest/php7.4/fpm/Dockerfile)
-	[`5.9.1-fpm-alpine`, `5.9-fpm-alpine`, `5-fpm-alpine`, `fpm-alpine`, `5.9.1-php7.4-fpm-alpine`, `5.9-php7.4-fpm-alpine`, `5-php7.4-fpm-alpine`, `php7.4-fpm-alpine`](https://github.com/docker-library/wordpress/blob/8874538f8ac8e2adc0beac9ab5e637a823addf3b/latest/php7.4/fpm-alpine/Dockerfile)
-	[`5.9.1-php7.3-apache`, `5.9-php7.3-apache`, `5-php7.3-apache`, `php7.3-apache`, `5.9.1-php7.3`, `5.9-php7.3`, `5-php7.3`, `php7.3`](https://github.com/docker-library/wordpress/blob/8874538f8ac8e2adc0beac9ab5e637a823addf3b/latest/php7.3/apache/Dockerfile)
-	[`5.9.1-php7.3-fpm`, `5.9-php7.3-fpm`, `5-php7.3-fpm`, `php7.3-fpm`](https://github.com/docker-library/wordpress/blob/8874538f8ac8e2adc0beac9ab5e637a823addf3b/latest/php7.3/fpm/Dockerfile)
-	[`5.9.1-php7.3-fpm-alpine`, `5.9-php7.3-fpm-alpine`, `5-php7.3-fpm-alpine`, `php7.3-fpm-alpine`](https://github.com/docker-library/wordpress/blob/8874538f8ac8e2adc0beac9ab5e637a823addf3b/latest/php7.3/fpm-alpine/Dockerfile)
-	[`5.9.1-php8.0-apache`, `5.9-php8.0-apache`, `5-php8.0-apache`, `php8.0-apache`, `5.9.1-php8.0`, `5.9-php8.0`, `5-php8.0`, `php8.0`](https://github.com/docker-library/wordpress/blob/8874538f8ac8e2adc0beac9ab5e637a823addf3b/latest/php8.0/apache/Dockerfile)
-	[`5.9.1-php8.0-fpm`, `5.9-php8.0-fpm`, `5-php8.0-fpm`, `php8.0-fpm`](https://github.com/docker-library/wordpress/blob/8874538f8ac8e2adc0beac9ab5e637a823addf3b/latest/php8.0/fpm/Dockerfile)
-	[`5.9.1-php8.0-fpm-alpine`, `5.9-php8.0-fpm-alpine`, `5-php8.0-fpm-alpine`, `php8.0-fpm-alpine`](https://github.com/docker-library/wordpress/blob/8874538f8ac8e2adc0beac9ab5e637a823addf3b/latest/php8.0/fpm-alpine/Dockerfile)
-	[`5.9.1-php8.1-apache`, `5.9-php8.1-apache`, `5-php8.1-apache`, `php8.1-apache`, `5.9.1-php8.1`, `5.9-php8.1`, `5-php8.1`, `php8.1`](https://github.com/docker-library/wordpress/blob/8874538f8ac8e2adc0beac9ab5e637a823addf3b/latest/php8.1/apache/Dockerfile)
-	[`5.9.1-php8.1-fpm`, `5.9-php8.1-fpm`, `5-php8.1-fpm`, `php8.1-fpm`](https://github.com/docker-library/wordpress/blob/8874538f8ac8e2adc0beac9ab5e637a823addf3b/latest/php8.1/fpm/Dockerfile)
-	[`5.9.1-php8.1-fpm-alpine`, `5.9-php8.1-fpm-alpine`, `5-php8.1-fpm-alpine`, `php8.1-fpm-alpine`](https://github.com/docker-library/wordpress/blob/8874538f8ac8e2adc0beac9ab5e637a823addf3b/latest/php8.1/fpm-alpine/Dockerfile)
