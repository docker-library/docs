...
-	[`5.7.0-apache`, `5.7-apache`, `5-apache`, `apache`, `5.7.0`, `5.7`, `5`, `latest`, `5.7.0-php7.4-apache`, `5.7-php7.4-apache`, `5-php7.4-apache`, `php7.4-apache`, `5.7.0-php7.4`, `5.7-php7.4`, `5-php7.4`, `php7.4`](https://github.com/docker-library/wordpress/blob/0e92d8964e59391c13ed9813318e9dfe339f0d19/latest/php7.4/apache/Dockerfile)
-	[`5.7.0-fpm`, `5.7-fpm`, `5-fpm`, `fpm`, `5.7.0-php7.4-fpm`, `5.7-php7.4-fpm`, `5-php7.4-fpm`, `php7.4-fpm`](https://github.com/docker-library/wordpress/blob/0e92d8964e59391c13ed9813318e9dfe339f0d19/latest/php7.4/fpm/Dockerfile)
...
-	[`5.7.0-php7.3-apache`, `5.7-php7.3-apache`, `5-php7.3-apache`, `php7.3-apache`, `5.7.0-php7.3`, `5.7-php7.3`, `5-php7.3`, `php7.3`](https://github.com/docker-library/wordpress/blob/0e92d8964e59391c13ed9813318e9dfe339f0d19/latest/php7.3/apache/Dockerfile)
-	[`5.7.0-php7.3-fpm`, `5.7-php7.3-fpm`, `5-php7.3-fpm`, `php7.3-fpm`](https://github.com/docker-library/wordpress/blob/0e92d8964e59391c13ed9813318e9dfe339f0d19/latest/php7.3/fpm/Dockerfile)
...
-	[`5.7.0-php8.0-apache`, `5.7-php8.0-apache`, `5-php8.0-apache`, `php8.0-apache`, `5.7.0-php8.0`, `5.7-php8.0`, `5-php8.0`, `php8.0`](https://github.com/docker-library/wordpress/blob/0e92d8964e59391c13ed9813318e9dfe339f0d19/latest/php8.0/apache/Dockerfile)
-	[`5.7.0-php8.0-fpm`, `5.7-php8.0-fpm`, `5-php8.0-fpm`, `php8.0-fpm`](https://github.com/docker-library/wordpress/blob/0e92d8964e59391c13ed9813318e9dfe339f0d19/latest/php8.0/fpm/Dockerfile)
...
-	[`beta-5.7.1-RC1-apache`, `beta-5.7.1-apache`, `beta-5.7-apache`, `beta-5-apache`, `beta-apache`, `beta-5.7.1-RC1`, `beta-5.7.1`, `beta-5.7`, `beta-5`, `beta`, `beta-5.7.1-RC1-php7.4-apache`, `beta-5.7.1-php7.4-apache`, `beta-5.7-php7.4-apache`, `beta-5-php7.4-apache`, `beta-php7.4-apache`, `beta-5.7.1-RC1-php7.4`, `beta-5.7.1-php7.4`, `beta-5.7-php7.4`, `beta-5-php7.4`, `beta-php7.4`](https://github.com/docker-library/wordpress/blob/0e92d8964e59391c13ed9813318e9dfe339f0d19/beta/php7.4/apache/Dockerfile)
-	[`beta-5.7.1-RC1-fpm`, `beta-5.7.1-fpm`, `beta-5.7-fpm`, `beta-5-fpm`, `beta-fpm`, `beta-5.7.1-RC1-php7.4-fpm`, `beta-5.7.1-php7.4-fpm`, `beta-5.7-php7.4-fpm`, `beta-5-php7.4-fpm`, `beta-php7.4-fpm`](https://github.com/docker-library/wordpress/blob/0e92d8964e59391c13ed9813318e9dfe339f0d19/beta/php7.4/fpm/Dockerfile)
...
-	[`beta-5.7.1-RC1-php7.3-apache`, `beta-5.7.1-php7.3-apache`, `beta-5.7-php7.3-apache`, `beta-5-php7.3-apache`, `beta-php7.3-apache`, `beta-5.7.1-RC1-php7.3`, `beta-5.7.1-php7.3`, `beta-5.7-php7.3`, `beta-5-php7.3`, `beta-php7.3`](https://github.com/docker-library/wordpress/blob/0e92d8964e59391c13ed9813318e9dfe339f0d19/beta/php7.3/apache/Dockerfile)
-	[`beta-5.7.1-RC1-php7.3-fpm`, `beta-5.7.1-php7.3-fpm`, `beta-5.7-php7.3-fpm`, `beta-5-php7.3-fpm`, `beta-php7.3-fpm`](https://github.com/docker-library/wordpress/blob/0e92d8964e59391c13ed9813318e9dfe339f0d19/beta/php7.3/fpm/Dockerfile)
...
-	[`beta-5.7.1-RC1-php8.0-apache`, `beta-5.7.1-php8.0-apache`, `beta-5.7-php8.0-apache`, `beta-5-php8.0-apache`, `beta-php8.0-apache`, `beta-5.7.1-RC1-php8.0`, `beta-5.7.1-php8.0`, `beta-5.7-php8.0`, `beta-5-php8.0`, `beta-php8.0`](https://github.com/docker-library/wordpress/blob/0e92d8964e59391c13ed9813318e9dfe339f0d19/beta/php8.0/apache/Dockerfile)
-	[`beta-5.7.1-RC1-php8.0-fpm`, `beta-5.7.1-php8.0-fpm`, `beta-5.7-php8.0-fpm`, `beta-5-php8.0-fpm`, `beta-php8.0-fpm`](https://github.com/docker-library/wordpress/blob/0e92d8964e59391c13ed9813318e9dfe339f0d19/beta/php8.0/fpm/Dockerfile)
