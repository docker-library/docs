...
-	[`7.0.1-php8.2-apache`, `7.0-php8.2-apache`, `7-php8.2-apache`, `php8.2-apache`, `7.0.1-php8.2`, `7.0-php8.2`, `7-php8.2`, `php8.2`](https://github.com/docker-library/wordpress/blob/abc2d453bf04d94816dc2fef3038e7a08a45dac0/latest/php8.2/apache/Dockerfile)

-	[`7.0.1-php8.2-fpm`, `7.0-php8.2-fpm`, `7-php8.2-fpm`, `php8.2-fpm`](https://github.com/docker-library/wordpress/blob/abc2d453bf04d94816dc2fef3038e7a08a45dac0/latest/php8.2/fpm/Dockerfile)

-	[`7.0.1-php8.2-fpm-alpine`, `7.0-php8.2-fpm-alpine`, `7-php8.2-fpm-alpine`, `php8.2-fpm-alpine`](https://github.com/docker-library/wordpress/blob/abc2d453bf04d94816dc2fef3038e7a08a45dac0/latest/php8.2/fpm-alpine/Dockerfile)

-	[`7.0.1-apache`, `7.0-apache`, `7-apache`, `apache`, `7.0.1`, `7.0`, `7`, `latest`, `7.0.1-php8.3-apache`, `7.0-php8.3-apache`, `7-php8.3-apache`, `php8.3-apache`, `7.0.1-php8.3`, `7.0-php8.3`, `7-php8.3`, `php8.3`](https://github.com/docker-library/wordpress/blob/abc2d453bf04d94816dc2fef3038e7a08a45dac0/latest/php8.3/apache/Dockerfile)

-	[`7.0.1-fpm`, `7.0-fpm`, `7-fpm`, `fpm`, `7.0.1-php8.3-fpm`, `7.0-php8.3-fpm`, `7-php8.3-fpm`, `php8.3-fpm`](https://github.com/docker-library/wordpress/blob/abc2d453bf04d94816dc2fef3038e7a08a45dac0/latest/php8.3/fpm/Dockerfile)

-	[`7.0.1-fpm-alpine`, `7.0-fpm-alpine`, `7-fpm-alpine`, `fpm-alpine`, `7.0.1-php8.3-fpm-alpine`, `7.0-php8.3-fpm-alpine`, `7-php8.3-fpm-alpine`, `php8.3-fpm-alpine`](https://github.com/docker-library/wordpress/blob/abc2d453bf04d94816dc2fef3038e7a08a45dac0/latest/php8.3/fpm-alpine/Dockerfile)

-	[`7.0.1-php8.4-apache`, `7.0-php8.4-apache`, `7-php8.4-apache`, `php8.4-apache`, `7.0.1-php8.4`, `7.0-php8.4`, `7-php8.4`, `php8.4`](https://github.com/docker-library/wordpress/blob/abc2d453bf04d94816dc2fef3038e7a08a45dac0/latest/php8.4/apache/Dockerfile)

-	[`7.0.1-php8.4-fpm`, `7.0-php8.4-fpm`, `7-php8.4-fpm`, `php8.4-fpm`](https://github.com/docker-library/wordpress/blob/abc2d453bf04d94816dc2fef3038e7a08a45dac0/latest/php8.4/fpm/Dockerfile)

-	[`7.0.1-php8.4-fpm-alpine`, `7.0-php8.4-fpm-alpine`, `7-php8.4-fpm-alpine`, `php8.4-fpm-alpine`](https://github.com/docker-library/wordpress/blob/abc2d453bf04d94816dc2fef3038e7a08a45dac0/latest/php8.4/fpm-alpine/Dockerfile)

-	[`7.0.1-php8.5-apache`, `7.0-php8.5-apache`, `7-php8.5-apache`, `php8.5-apache`, `7.0.1-php8.5`, `7.0-php8.5`, `7-php8.5`, `php8.5`](https://github.com/docker-library/wordpress/blob/abc2d453bf04d94816dc2fef3038e7a08a45dac0/latest/php8.5/apache/Dockerfile)

-	[`7.0.1-php8.5-fpm`, `7.0-php8.5-fpm`, `7-php8.5-fpm`, `php8.5-fpm`](https://github.com/docker-library/wordpress/blob/abc2d453bf04d94816dc2fef3038e7a08a45dac0/latest/php8.5/fpm/Dockerfile)

-	[`7.0.1-php8.5-fpm-alpine`, `7.0-php8.5-fpm-alpine`, `7-php8.5-fpm-alpine`, `php8.5-fpm-alpine`](https://github.com/docker-library/wordpress/blob/abc2d453bf04d94816dc2fef3038e7a08a45dac0/latest/php8.5/fpm-alpine/Dockerfile)
...
-	[`beta-7.1-beta1-php8.2-apache`, `beta-7.1-php8.2-apache`, `beta-7-php8.2-apache`, `beta-php8.2-apache`, `beta-7.1-beta1-php8.2`, `beta-7.1-php8.2`, `beta-7-php8.2`, `beta-php8.2`](https://github.com/docker-library/wordpress/blob/b45c0f2cd1f4b63abb3138a65d69a0e452bf95d4/beta/php8.2/apache/Dockerfile)

-	[`beta-7.1-beta1-php8.2-fpm`, `beta-7.1-php8.2-fpm`, `beta-7-php8.2-fpm`, `beta-php8.2-fpm`](https://github.com/docker-library/wordpress/blob/b45c0f2cd1f4b63abb3138a65d69a0e452bf95d4/beta/php8.2/fpm/Dockerfile)

-	[`beta-7.1-beta1-php8.2-fpm-alpine`, `beta-7.1-php8.2-fpm-alpine`, `beta-7-php8.2-fpm-alpine`, `beta-php8.2-fpm-alpine`](https://github.com/docker-library/wordpress/blob/b45c0f2cd1f4b63abb3138a65d69a0e452bf95d4/beta/php8.2/fpm-alpine/Dockerfile)

-	[`beta-7.1-beta1-apache`, `beta-7.1-apache`, `beta-7-apache`, `beta-apache`, `beta-7.1-beta1`, `beta-7.1`, `beta-7`, `beta`, `beta-7.1-beta1-php8.3-apache`, `beta-7.1-php8.3-apache`, `beta-7-php8.3-apache`, `beta-php8.3-apache`, `beta-7.1-beta1-php8.3`, `beta-7.1-php8.3`, `beta-7-php8.3`, `beta-php8.3`](https://github.com/docker-library/wordpress/blob/b45c0f2cd1f4b63abb3138a65d69a0e452bf95d4/beta/php8.3/apache/Dockerfile)

-	[`beta-7.1-beta1-fpm`, `beta-7.1-fpm`, `beta-7-fpm`, `beta-fpm`, `beta-7.1-beta1-php8.3-fpm`, `beta-7.1-php8.3-fpm`, `beta-7-php8.3-fpm`, `beta-php8.3-fpm`](https://github.com/docker-library/wordpress/blob/b45c0f2cd1f4b63abb3138a65d69a0e452bf95d4/beta/php8.3/fpm/Dockerfile)

-	[`beta-7.1-beta1-fpm-alpine`, `beta-7.1-fpm-alpine`, `beta-7-fpm-alpine`, `beta-fpm-alpine`, `beta-7.1-beta1-php8.3-fpm-alpine`, `beta-7.1-php8.3-fpm-alpine`, `beta-7-php8.3-fpm-alpine`, `beta-php8.3-fpm-alpine`](https://github.com/docker-library/wordpress/blob/b45c0f2cd1f4b63abb3138a65d69a0e452bf95d4/beta/php8.3/fpm-alpine/Dockerfile)

-	[`beta-7.1-beta1-php8.4-apache`, `beta-7.1-php8.4-apache`, `beta-7-php8.4-apache`, `beta-php8.4-apache`, `beta-7.1-beta1-php8.4`, `beta-7.1-php8.4`, `beta-7-php8.4`, `beta-php8.4`](https://github.com/docker-library/wordpress/blob/b45c0f2cd1f4b63abb3138a65d69a0e452bf95d4/beta/php8.4/apache/Dockerfile)

-	[`beta-7.1-beta1-php8.4-fpm`, `beta-7.1-php8.4-fpm`, `beta-7-php8.4-fpm`, `beta-php8.4-fpm`](https://github.com/docker-library/wordpress/blob/b45c0f2cd1f4b63abb3138a65d69a0e452bf95d4/beta/php8.4/fpm/Dockerfile)

-	[`beta-7.1-beta1-php8.4-fpm-alpine`, `beta-7.1-php8.4-fpm-alpine`, `beta-7-php8.4-fpm-alpine`, `beta-php8.4-fpm-alpine`](https://github.com/docker-library/wordpress/blob/b45c0f2cd1f4b63abb3138a65d69a0e452bf95d4/beta/php8.4/fpm-alpine/Dockerfile)

-	[`beta-7.1-beta1-php8.5-apache`, `beta-7.1-php8.5-apache`, `beta-7-php8.5-apache`, `beta-php8.5-apache`, `beta-7.1-beta1-php8.5`, `beta-7.1-php8.5`, `beta-7-php8.5`, `beta-php8.5`](https://github.com/docker-library/wordpress/blob/b45c0f2cd1f4b63abb3138a65d69a0e452bf95d4/beta/php8.5/apache/Dockerfile)

-	[`beta-7.1-beta1-php8.5-fpm`, `beta-7.1-php8.5-fpm`, `beta-7-php8.5-fpm`, `beta-php8.5-fpm`](https://github.com/docker-library/wordpress/blob/b45c0f2cd1f4b63abb3138a65d69a0e452bf95d4/beta/php8.5/fpm/Dockerfile)

-	[`beta-7.1-beta1-php8.5-fpm-alpine`, `beta-7.1-php8.5-fpm-alpine`, `beta-7-php8.5-fpm-alpine`, `beta-php8.5-fpm-alpine`](https://github.com/docker-library/wordpress/blob/b45c0f2cd1f4b63abb3138a65d69a0e452bf95d4/beta/php8.5/fpm-alpine/Dockerfile)
