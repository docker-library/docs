...
```console
$ docker pull library/mono@sha256:53cae49563ac7a227a977688447782d06805b8266cceaa89c0fb36bdb227a0f6
```
...
```console
$ docker pull library/mono@sha256:38e66eb5ebfbc6b4a7afacb1ea57b5dda88d10d1afc2032fbcb0136d7dd01dd8
```
...
```console
$ docker pull library/mono@sha256:3e42512b7f1b3dfdea7583ae175abca36942632b1c0cf1100569a08598d4641a
```

-	Total Virtual Size: 622.3 MB (622313669 bytes)
-	Total v2 Content-Length: 227.5 MB (227468957 bytes)
...
```console
$ docker pull library/mono@sha256:0cd532703df386542aef572e7d941e19700f86776ff36626c22094951fb8adc1
```
...
```console
$ docker pull library/mono@sha256:ea39c99a4aa93559dd09ca6d47524e8f47add73306211081e1fe66c0c255f582
```
...
```console
$ docker pull library/mono@sha256:fda4f648f23003117fc81f0f1bc179aece2a1a8da61afd3cc4a6467cf21be7c3
```
...
```console
$ docker pull library/mono@sha256:a67785c79777007b8e0bae4bf40b56a095e69c0c2cb5988571f03a369c8db56c
```
...
```console
$ docker pull library/mono@sha256:1cdf08ccd1d619d1fa4e63275d6646f7f191b948a2a62ced7728ded4f26eafde
```
...
```console
$ docker pull library/mono@sha256:eb513a2376b8ea9ceca3b15351de69433f5336923cf5abbfac68117d25408d6a
```
