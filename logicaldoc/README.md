...
-	**Where to get help**:  
	[the LogicalDOC Community Forums](http://forums.logicaldoc.com/)

-	**Where to file issues**:  
	[http://bugs.logicaldoc.com)

-	**Maintained by**:  
	[LogicalDOC](https://github.com/logicaldoc/docker-logicaldoc)

-	**Published image artifact details**:  
	[repo-info repo's `repos/ilogicaldoc/` directory](https://github.com/docker-library/repo-info/blob/master/repos/ilogicaldoc) ([history](https://github.com/docker-library/repo-info/commits/master/repos/logicaldoc))  
