...
**Note:** this is the "per-architecture" repository for the `riscv64` builds of [the `registry` official image](https://hub.docker.com/_/registry) -- for more information, see ["Architectures other than amd64?" in the official images documentation](https://github.com/docker-library/official-images#architectures-other-than-amd64) and ["An image's source changed in Git, now what?" in the official images FAQ](https://github.com/docker-library/faq#an-images-source-changed-in-git-now-what).
...
-	[`3.0.0-rc.2`](https://github.com/distribution/distribution-library-image/blob/588e2e5ee607521e48cdc66147a42a2b6decd749/Dockerfile)

[![riscv64/registry build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/riscv64/job/registry.svg?label=riscv64/registry%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/riscv64/job/registry/)
...
```console
$ docker run -d -p 5000:5000 --restart always --name registry riscv64/registry:2
```
