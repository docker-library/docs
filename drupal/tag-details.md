...
```console
$ docker pull drupal@sha256:7d88f397a1ebf1f334676ea03cec55d366c9fe36669557b221368ef5cbda9785
```

-	Platforms:
	-	linux; amd64

### `drupal:8.1.6-apache` - linux; amd64

-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.9 MB (183936597 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e6ac6833fe3b3e28fe428ec948b3a24f72b674e8a81b6d684a186c96144e3e9`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /var/www/html
# Thu, 14 Jul 2016 03:09:04 GMT
ENV DRUPAL_VERSION=8.1.6
# Thu, 14 Jul 2016 03:09:04 GMT
ENV DRUPAL_MD5=f3fdd2f9266938c2c7afc091e8d6e6d1
# Thu, 14 Jul 2016 03:09:13 GMT
RUN curl -fSL "http://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz 	&& echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c - 	&& tar -xz --strip-components=1 -f drupal.tar.gz 	&& rm drupal.tar.gz 	&& chown -R www-data:www-data sites
```
...
-	Layers:
	...
	-	`sha256:3638e74f0853e8604be47993a605ca3f215b80d1b78b5d6f07c7e6d0622e06f3`  
		...
		Size: 331.0 B
	-	`sha256:3e2d61974d3d89948cdbfb8f2258cc0e9bfb049fd9856f9d698b88b310f3d19c`  
		Last Modified: Thu, 14 Jul 2016 03:14:33 GMT  
		Size: 12.6 MB (12560247 bytes)
...
```console
$ docker pull drupal@sha256:db76cc2b8b3490d55003b18506365c6bdc25b87cf305a90e3187e8a159894e8c
```

-	Platforms:
	-	linux; amd64

### `drupal:8.1.6-fpm` - linux; amd64

-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.1 MB (174086247 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24b1482313ce29860a66c893716bb2bb9b20dd2742b2dc1244ddde99a7af8f81`
-	Default Command: `["php-fpm"]`
...
# Thu, 14 Jul 2016 03:12:57 GMT
ENV DRUPAL_VERSION=8.1.6
# Thu, 14 Jul 2016 03:12:58 GMT
ENV DRUPAL_MD5=f3fdd2f9266938c2c7afc091e8d6e6d1
# Thu, 14 Jul 2016 03:13:06 GMT
RUN curl -fSL "http://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz 	&& echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c - 	&& tar -xz --strip-components=1 -f drupal.tar.gz 	&& rm drupal.tar.gz 	&& chown -R www-data:www-data sites
```
...
-	Layers:
	...
	-	`sha256:3090549da9b84bbfeba91aadbc0db38aabff7607df83978c33a5e4bc3a337cbe`  
		...
		Size: 333.0 B
	-	`sha256:fb97b1c41426065e9591dfa57fa3400146e9c73124ab69a86a77652726c384c9`  
		Last Modified: Thu, 14 Jul 2016 03:16:01 GMT  
		Size: 12.6 MB (12560229 bytes)
