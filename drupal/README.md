...
-	[`9.2.8-php8.0-apache-buster`, `9.2-php8.0-apache-buster`, `9-php8.0-apache-buster`, `php8.0-apache-buster`, `9.2.8-php8.0-apache`, `9.2-php8.0-apache`, `9-php8.0-apache`, `php8.0-apache`, `9.2.8-apache-buster`, `9.2-apache-buster`, `9-apache-buster`, `apache-buster`, `9.2.8-apache`, `9.2-apache`, `9-apache`, `apache`, `9.2.8`, `9.2`, `9`, `latest`, `9.2.8-php8.0`, `9.2-php8.0`, `9-php8.0`, `php8.0`](https://github.com/docker-library/drupal/blob/d83a2d846c88398fa377d9c7722f687e11e6e69f/9.2/php8.0/apache-buster/Dockerfile)
-	[`9.2.8-php8.0-fpm-buster`, `9.2-php8.0-fpm-buster`, `9-php8.0-fpm-buster`, `php8.0-fpm-buster`, `9.2.8-php8.0-fpm`, `9.2-php8.0-fpm`, `9-php8.0-fpm`, `php8.0-fpm`, `9.2.8-fpm-buster`, `9.2-fpm-buster`, `9-fpm-buster`, `fpm-buster`, `9.2.8-fpm`, `9.2-fpm`, `9-fpm`, `fpm`](https://github.com/docker-library/drupal/blob/d83a2d846c88398fa377d9c7722f687e11e6e69f/9.2/php8.0/fpm-buster/Dockerfile)
-	[`9.2.8-php8.0-fpm-alpine3.14`, `9.2-php8.0-fpm-alpine3.14`, `9-php8.0-fpm-alpine3.14`, `php8.0-fpm-alpine3.14`, `9.2.8-php8.0-fpm-alpine`, `9.2-php8.0-fpm-alpine`, `9-php8.0-fpm-alpine`, `php8.0-fpm-alpine`, `9.2.8-fpm-alpine3.14`, `9.2-fpm-alpine3.14`, `9-fpm-alpine3.14`, `fpm-alpine3.14`, `9.2.8-fpm-alpine`, `9.2-fpm-alpine`, `9-fpm-alpine`, `fpm-alpine`](https://github.com/docker-library/drupal/blob/d83a2d846c88398fa377d9c7722f687e11e6e69f/9.2/php8.0/fpm-alpine3.14/Dockerfile)
-	[`9.2.8-php8.0-fpm-alpine3.13`, `9.2-php8.0-fpm-alpine3.13`, `9-php8.0-fpm-alpine3.13`, `php8.0-fpm-alpine3.13`, `9.2.8-fpm-alpine3.13`, `9.2-fpm-alpine3.13`, `9-fpm-alpine3.13`, `fpm-alpine3.13`](https://github.com/docker-library/drupal/blob/d83a2d846c88398fa377d9c7722f687e11e6e69f/9.2/php8.0/fpm-alpine3.13/Dockerfile)
-	[`9.2.8-php7.4-apache-buster`, `9.2-php7.4-apache-buster`, `9-php7.4-apache-buster`, `php7.4-apache-buster`, `9.2.8-php7.4-apache`, `9.2-php7.4-apache`, `9-php7.4-apache`, `php7.4-apache`](https://github.com/docker-library/drupal/blob/d83a2d846c88398fa377d9c7722f687e11e6e69f/9.2/php7.4/apache-buster/Dockerfile)
-	[`9.2.8-php7.4-fpm-buster`, `9.2-php7.4-fpm-buster`, `9-php7.4-fpm-buster`, `php7.4-fpm-buster`, `9.2.8-php7.4-fpm`, `9.2-php7.4-fpm`, `9-php7.4-fpm`, `php7.4-fpm`](https://github.com/docker-library/drupal/blob/d83a2d846c88398fa377d9c7722f687e11e6e69f/9.2/php7.4/fpm-buster/Dockerfile)
-	[`9.2.8-php7.4-fpm-alpine3.14`, `9.2-php7.4-fpm-alpine3.14`, `9-php7.4-fpm-alpine3.14`, `php7.4-fpm-alpine3.14`, `9.2.8-php7.4-fpm-alpine`, `9.2-php7.4-fpm-alpine`, `9-php7.4-fpm-alpine`, `php7.4-fpm-alpine`](https://github.com/docker-library/drupal/blob/d83a2d846c88398fa377d9c7722f687e11e6e69f/9.2/php7.4/fpm-alpine3.14/Dockerfile)
-	[`9.2.8-php7.4-fpm-alpine3.13`, `9.2-php7.4-fpm-alpine3.13`, `9-php7.4-fpm-alpine3.13`, `php7.4-fpm-alpine3.13`](https://github.com/docker-library/drupal/blob/d83a2d846c88398fa377d9c7722f687e11e6e69f/9.2/php7.4/fpm-alpine3.13/Dockerfile)
