...
```console
$ docker pull library/redmine@sha256:72316f9d916c1ddfe2d9ff35059a139884b740deab4b50a48cb02c0e4a0599b6
```
...
```console
$ docker pull library/redmine@sha256:17b238b17c2d88d47f971bde9cfbab3dd9fc608bead2709bcf1c5817cb2616b6
```
...
```console
$ docker pull library/redmine@sha256:d81138d86648aa6762be49be4688bbec8af493a2a1a1c83f548151c81e0cb753
```
...
```console
$ docker pull library/redmine@sha256:98280b9ea665224a7bc9225ce7e698e09432b1323384074081d242924134b77e
```
