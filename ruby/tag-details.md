...
```console
$ docker pull library/ruby@sha256:802323f6a55b279c45a98304873a3b2a7bdebbfaff286e95b47b4a02561939db
```
...
```console
$ docker pull library/ruby@sha256:1be7701285c8eae2c37264e98a47b34006dcecd5571e5299743b95641d2f5771
```
...
```console
$ docker pull library/ruby@sha256:823eba6bda9ce3b38cb361e71d25a6c41f4e44eec8e7e583876d7362d7282c40
```
...
```console
$ docker pull library/ruby@sha256:ad18e407b6005b9a126f609fbb91b7bf8841407d7b75164fa81fbeaad3506984
```
...
```console
$ docker pull library/ruby@sha256:6602873585909be9b6475b792ea323e1b470beb7e035d2c37881fb6635addf5d
```
...
```console
$ docker pull library/ruby@sha256:db72d5a30c3104a1d29f08e1920b5381f616284df03d43890ce308f191b973c8
```
...
```console
$ docker pull library/ruby@sha256:56ef18b5a674c54ed023ab02fce7f214346de60f5bfc57a3c34be733a4c9d309
```
...
```console
$ docker pull library/ruby@sha256:b5f3c736ade52f3c8bcff2966f6ce9fdfde0c3158811df687732652c9bfb77a1
```
...
```console
$ docker pull library/ruby@sha256:29a508b0e69aa409d43ca7b6d7ca13f45e4036721e73d417a5790e3a40111833
```
