...
-	[`6.64.0-bookworm`, `6.64.0`, `6.64-bookworm`, `6.64`, `6-bookworm`, `6`, `bookworm`, `latest`](https://github.com/TryGhost/docker-library-ghost/blob/41fe7e833ca4e3524d9cd2d2d3d122bbe7a10cf9/6/bookworm/Dockerfile)

-	[`6.64.0-alpine3.23`, `6.64.0-alpine`, `6.64-alpine3.23`, `6.64-alpine`, `6-alpine3.23`, `6-alpine`, `alpine3.23`, `alpine`](https://github.com/TryGhost/docker-library-ghost/blob/41fe7e833ca4e3524d9cd2d2d3d122bbe7a10cf9/6/alpine3.23/Dockerfile)

-	[`6.64.0-next-bookworm`, `6.64.0-next`, `6.64-next-bookworm`, `6.64-next`, `6-next-bookworm`, `6-next`, `next-bookworm`, `next`](https://github.com/TryGhost/docker-library-ghost/blob/41fe7e833ca4e3524d9cd2d2d3d122bbe7a10cf9/6-next/bookworm/Dockerfile)

-	[`6.64.0-next-alpine3.23`, `6.64.0-next-alpine`, `6.64-next-alpine3.23`, `6.64-next-alpine`, `6-next-alpine3.23`, `6-next-alpine`, `next-alpine3.23`, `next-alpine`](https://github.com/TryGhost/docker-library-ghost/blob/41fe7e833ca4e3524d9cd2d2d3d122bbe7a10cf9/6-next/alpine3.23/Dockerfile)
...
The `next` tags (`amd64/ghost:next`, `amd64/ghost:6-next`, `amd64/ghost:next-alpine`, plus fully qualified variants such as `amd64/ghost:6.61.0-next-alpine3.23`) are a preview of the image that will become the standard `amd64/ghost` image in **Ghost 7.0**. They track the same stable upstream Ghost releases as the default tags; what differs is how the image is built and laid out, not which version of Ghost is inside. The `next` tags never carry `latest`.

When Ghost 7.0 ships, this layout becomes the plain `amd64/ghost:<version>` image and the `next` tags go away, so trying `next` now is the way to find breakage in your setup ahead of that switch.
