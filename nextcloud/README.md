...
-	[`18.0.12-apache`, `18.0-apache`, `18-apache`, `18.0.12`, `18.0`, `18`](https://github.com/nextcloud/docker/blob/b23910be9215f8338aee419007feb70cdacb7741/18.0/apache/Dockerfile)
-	[`18.0.12-fpm`, `18.0-fpm`, `18-fpm`](https://github.com/nextcloud/docker/blob/b23910be9215f8338aee419007feb70cdacb7741/18.0/fpm/Dockerfile)
-	[`18.0.12-fpm-alpine`, `18.0-fpm-alpine`, `18-fpm-alpine`](https://github.com/nextcloud/docker/blob/b23910be9215f8338aee419007feb70cdacb7741/18.0/fpm-alpine/Dockerfile)
-	[`18.0.13RC1-apache`, `18.0.13-rc-apache`, `18.0-rc-apache`, `18-rc-apache`, `18.0.13RC1`, `18.0.13-rc`, `18.0-rc`, `18-rc`](https://github.com/nextcloud/docker/blob/12747113eac11046eb65ec7c907983994213723b/18.0-rc/apache/Dockerfile)
-	[`18.0.13RC1-fpm`, `18.0.13-rc-fpm`, `18.0-rc-fpm`, `18-rc-fpm`](https://github.com/nextcloud/docker/blob/12747113eac11046eb65ec7c907983994213723b/18.0-rc/fpm/Dockerfile)
-	[`18.0.13RC1-fpm-alpine`, `18.0.13-rc-fpm-alpine`, `18.0-rc-fpm-alpine`, `18-rc-fpm-alpine`](https://github.com/nextcloud/docker/blob/12747113eac11046eb65ec7c907983994213723b/18.0-rc/fpm-alpine/Dockerfile)
-	[`19.0.6-apache`, `19.0-apache`, `19-apache`, `19.0.6`, `19.0`, `19`](https://github.com/nextcloud/docker/blob/b23910be9215f8338aee419007feb70cdacb7741/19.0/apache/Dockerfile)
-	[`19.0.6-fpm`, `19.0-fpm`, `19-fpm`](https://github.com/nextcloud/docker/blob/b23910be9215f8338aee419007feb70cdacb7741/19.0/fpm/Dockerfile)
-	[`19.0.6-fpm-alpine`, `19.0-fpm-alpine`, `19-fpm-alpine`](https://github.com/nextcloud/docker/blob/b23910be9215f8338aee419007feb70cdacb7741/19.0/fpm-alpine/Dockerfile)
-	[`19.0.7RC1-apache`, `19.0.7-rc-apache`, `19.0-rc-apache`, `19-rc-apache`, `19.0.7RC1`, `19.0.7-rc`, `19.0-rc`, `19-rc`](https://github.com/nextcloud/docker/blob/12747113eac11046eb65ec7c907983994213723b/19.0-rc/apache/Dockerfile)
-	[`19.0.7RC1-fpm`, `19.0.7-rc-fpm`, `19.0-rc-fpm`, `19-rc-fpm`](https://github.com/nextcloud/docker/blob/12747113eac11046eb65ec7c907983994213723b/19.0-rc/fpm/Dockerfile)
-	[`19.0.7RC1-fpm-alpine`, `19.0.7-rc-fpm-alpine`, `19.0-rc-fpm-alpine`, `19-rc-fpm-alpine`](https://github.com/nextcloud/docker/blob/12747113eac11046eb65ec7c907983994213723b/19.0-rc/fpm-alpine/Dockerfile)
-	[`20.0.4-apache`, `20.0-apache`, `20-apache`, `apache`, `stable-apache`, `production-apache`, `20.0.4`, `20.0`, `20`, `latest`, `stable`, `production`](https://github.com/nextcloud/docker/blob/b23910be9215f8338aee419007feb70cdacb7741/20.0/apache/Dockerfile)
-	[`20.0.4-fpm`, `20.0-fpm`, `20-fpm`, `fpm`, `stable-fpm`, `production-fpm`](https://github.com/nextcloud/docker/blob/b23910be9215f8338aee419007feb70cdacb7741/20.0/fpm/Dockerfile)
-	[`20.0.4-fpm-alpine`, `20.0-fpm-alpine`, `20-fpm-alpine`, `fpm-alpine`, `stable-fpm-alpine`, `production-fpm-alpine`](https://github.com/nextcloud/docker/blob/b23910be9215f8338aee419007feb70cdacb7741/20.0/fpm-alpine/Dockerfile)
-	[`21.0.0beta4-apache`, `21.0.0-beta-apache`, `21.0-beta-apache`, `21-beta-apache`, `21.0.0beta4`, `21.0.0-beta`, `21.0-beta`, `21-beta`](https://github.com/nextcloud/docker/blob/e5b568e52f0facf73515c0a7eb749bb2c8e2c4d0/21.0-beta/apache/Dockerfile)
-	[`21.0.0beta4-fpm`, `21.0.0-beta-fpm`, `21.0-beta-fpm`, `21-beta-fpm`](https://github.com/nextcloud/docker/blob/e5b568e52f0facf73515c0a7eb749bb2c8e2c4d0/21.0-beta/fpm/Dockerfile)
-	[`21.0.0beta4-fpm-alpine`, `21.0.0-beta-fpm-alpine`, `21.0-beta-fpm-alpine`, `21-beta-fpm-alpine`](https://github.com/nextcloud/docker/blob/e5b568e52f0facf73515c0a7eb749bb2c8e2c4d0/21.0-beta/fpm-alpine/Dockerfile)
