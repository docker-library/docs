...
[![riscv64/rapidoid build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/riscv64/job/rapidoid.svg?label=riscv64/rapidoid%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/riscv64/job/rapidoid/)
...
```console
$ docker run --rm riscv64/rapidoid --help
```
