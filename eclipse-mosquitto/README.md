...
The supported-tags list at the top of this page is authoritative. Official `riscv64/eclipse-mosquitto` images are Alpine-based. Tag naming does **not** follow a generic "plain version" vs "version-alpine" split:
