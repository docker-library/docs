...
-	[`2.1.0-alpine`, `2.1-alpine`, `alpine`, `latest`](https://github.com/eclipse-mosquitto/mosquitto/blob/3bddd1affe63b501de83c6e8e5ffbf23912cd29d/docker/2.1-alpine/Dockerfile)

-	[`2.0.22`, `2.0.22-openssl`, `2.0`, `2.0-openssl`, `2`, `2-openssl`, `openssl`](https://github.com/eclipse-mosquitto/mosquitto/blob/3bddd1affe63b501de83c6e8e5ffbf23912cd29d/docker/2.0-openssl/Dockerfile)

-	[`1.6.15-openssl`, `1.6-openssl`](https://github.com/eclipse-mosquitto/mosquitto/blob/3bddd1affe63b501de83c6e8e5ffbf23912cd29d/docker/1.6-openssl/Dockerfile)
...
```console
$ docker run -it -p 1883:1883 -v "$PWD/mosquitto/config:/mosquitto/config" arm64v8/eclipse-mosquitto
```
...
```console
$ docker run -it -p 1883:1883 -v "$PWD/mosquitto/config:/mosquitto/config" -v /mosquitto/data -v /mosquitto/log arm64v8/eclipse-mosquitto
```

or:

```console
$ docker run -it -p 1883:1883 -v "$PWD/mosquitto/config:/mosquitto/config" -v "$PWD/mosquitto/data:/mosquitto/data" -v "$PWD/mosquitto/log:/mosquitto/log" arm64v8/eclipse-mosquitto
```
...
```console
$ docker run -it -p 1883:1883 -p 8080:8080 -v "$PWD/mosquitto/config:/mosquitto/config" arm64v8/eclipse-mosquitto
```

# Image Variants

The `arm64v8/eclipse-mosquitto` images come in many flavors, each designed for a specific use case.

## `arm64v8/eclipse-mosquitto:<version>`

This is the defacto image. If you are unsure about what your needs are, you probably want to use this one. It is designed to be used both as a throw away container (mount your source code and start the container to start your app), as well as the base to build other images off of.

## `arm64v8/eclipse-mosquitto:<version>-alpine`
