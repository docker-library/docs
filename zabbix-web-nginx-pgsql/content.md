...
Zabbix web interface is a part of Zabbix software. It is used to manage resources under monitoring and view monitoring statistics. The image based on Nginx web server with PostgreSQL database support.
