...
```console
$ docker run -d --name C8O -e CONVERTIGO_ANONYMOUS_DASHBOARD=true -p 28080:28080 mips64le/convertigo
```
...
```console
$ docker run -d –name C8O -e ENABLE_JDWP_DEBUG=true -p 28080:28080 mips64le/convertigo
```
