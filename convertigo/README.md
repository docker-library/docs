...
$ docker run -d --name C8O \
    ...
    -p 28080:28080 ppc64le/convertigo
```
...
$ docker run --name C8O -v "$(pwd)/workspace:/workspace" -d -p 28080:28080 ppc64le/convertigo
```
...
```console
$ docker run -d --name C8O -e CONVERTIGO_ANONYMOUS_DASHBOARD=true -p 28080:28080 ppc64le/convertigo
```
...
```console
$ docker run -d --name C8O -e PUBLIC_DOMAINS="https://app.example.com#https://admin.example.com" -p 28080:28080 ppc64le/convertigo
```
...
```console
$ docker run -d --name C8O -e LOG_STDOUT=true -e LOG_FILE=false -p 28080:28080 ppc64le/convertigo
```
...
```console
$ docker run -d --name C8O -e ENABLE_JDWP_DEBUG=true -p 28080:28080 -p 8000:8000 ppc64le/convertigo
```
