...
```console
$ docker stop mips64le/odoo
$ docker start -a mips64le/odoo
```
...
```console
$ docker run -v odoo-data:/var/lib/odoo -d -p 8069:8069 --name odoo --link db:db -t mips64le/odoo
```
