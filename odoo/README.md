...
```console
$ docker stop winamd64/odoo
$ docker start -a winamd64/odoo
```
...
```console
$ docker run -v odoo-data:/var/lib/odoo -d -p 8069:8069 --name odoo --link db:db -t winamd64/odoo
```
