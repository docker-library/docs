...
```console
$ docker stop arm32v7/odoo
$ docker start -a arm32v7/odoo
```
...
```console
$ docker run -v odoo-data:/var/lib/odoo -d -p 8069:8069 --name odoo --link db:db -t arm32v7/odoo
```
