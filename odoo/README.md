...
```console
$ docker stop riscv64/odoo
$ docker start -a riscv64/odoo
```
...
```console
$ docker run -v odoo-data:/var/lib/odoo -d -p 8069:8069 --name odoo --link db:db -t riscv64/odoo
```
