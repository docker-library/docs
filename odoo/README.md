...
```console
$ docker stop s390x/odoo
$ docker start -a s390x/odoo
```
...
```console
$ docker run -v odoo-data:/var/lib/odoo -d -p 8069:8069 --name odoo --link db:db -t s390x/odoo
```
