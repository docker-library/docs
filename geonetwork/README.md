...
-	[`3.4.1-postgres`, `3.4-postgres`, `postgres` (*3.4.1/postgres/Dockerfile*)](https://github.com/geonetwork/docker-geonetwork/blob/01e3e23e9b277940dcac471099408695c6d12ae3/3.4.1/postgres/Dockerfile)
