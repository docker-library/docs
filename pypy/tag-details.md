...
```console
$ docker pull library/pypy@sha256:9ef1a51281072deb2d65893a592c5874b150e48d871f198824b0bd564ae84fa4
```
...
```console
$ docker pull library/pypy@sha256:f1be4ebea7c25dc848ea4de207b72f48cd3dafd96d0cd7982f4634fc582283c4
```
