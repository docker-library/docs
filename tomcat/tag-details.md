...
-	[`tomcat:7.0`](#tomcat70)
-	[`tomcat:7`](#tomcat7)
-	[`tomcat:7.0.70-jre7-alpine`](#tomcat7070-jre7-alpine)
-	[`tomcat:7.0-jre7-alpine`](#tomcat70-jre7-alpine)
-	[`tomcat:7-jre7-alpine`](#tomcat7-jre7-alpine)
-	[`tomcat:7.0.70-alpine`](#tomcat7070-alpine)
...
-	[`tomcat:7.0.70-jre8-alpine`](#tomcat7070-jre8-alpine)
...
-	[`tomcat:9.0.0.M9-alpine`](#tomcat900m9-alpine)
...
```console
$ docker pull tomcat@sha256:a66077c0119bcd43467bb6ecd1cc3102b61e7574f042e655aaab73fea221f667
```
...
-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **132.3 MB (132305892 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c27e5937e72bc3f00a23d1f8715d51634fceb6f6e95df3b067bea2b31c0d3731`
-	Default Command: `["catalina.sh","run"]`
...
WORKDIR /usr/local/tomcat
# Wed, 03 Aug 2016 20:17:58 GMT
RUN apt-get update && apt-get install -y libapr1 && rm -rf /var/lib/apt/lists/*
# Wed, 03 Aug 2016 20:19:10 GMT
RUN set -ex 	&& for key in 		05AB33110949707C93A279E3D3EFE6B686867BA6 		07E48665A34DCAFAE522E5E6266191C37C037D42 		47309207D818FFD8DCD3F83F1931D684307A10A5 		541FBE7D8F78B25E055DDEE13C370389288584E7 		61B832AC2F1C5A90F0F9B00A1C506407564C17A3 		79F7026C690BAA50B92CD8B66A3AD3F4F22C4FED 		80FF76D88A969FE46108558A80B953A041E49465 		8B39757B1D8A994DF2433ED58B3A601F08C975E5 		A27677289986DB50844682F8ACB77FC2E86E29AC 		A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 		B3F49CD3B9BD2996DA90F817ED3873F5D3262722 		DCFD35E0BF8CA7344752DE8B6FB21E8933C60243 		F3A04C595DB5B6A5F1ECA43E3B7BBB100D811BBE 		F7DA48BB64BCB84ECBA7EE6935CD23C10D498E23 	; do 		gpg --keyserver ha.pool.sks-keyservers.net --recv-keys "$key"; 	done
# Wed, 03 Aug 2016 20:19:13 GMT
ENV TOMCAT_MAJOR=6
# Wed, 03 Aug 2016 20:19:14 GMT
ENV TOMCAT_VERSION=6.0.45
# Wed, 03 Aug 2016 20:19:15 GMT
ENV TOMCAT_TGZ_URL=https://www.apache.org/dist/tomcat/tomcat-6/v6.0.45/bin/apache-tomcat-6.0.45.tar.gz
# Wed, 03 Aug 2016 20:21:25 GMT
RUN set -x 		&& curl -fSL "$TOMCAT_TGZ_URL" -o tomcat.tar.gz 	&& curl -fSL "$TOMCAT_TGZ_URL.asc" -o tomcat.tar.gz.asc 	&& gpg --batch --verify tomcat.tar.gz.asc tomcat.tar.gz 	&& tar -xvf tomcat.tar.gz --strip-components=1 	&& rm bin/*.bat 	&& rm tomcat.tar.gz* 		&& nativeBuildDir="$(mktemp -d)" 	&& tar -xvf bin/tomcat-native.tar.gz -C "$nativeBuildDir" --strip-components=1 	&& nativeBuildDeps=" 		gcc 		libapr1-dev 		libssl-dev 		make 		openjdk-${JAVA_VERSION%%[-~bu]*}-jdk=$JAVA_DEBIAN_VERSION 	" 	&& apt-get update && apt-get install -y --no-install-recommends $nativeBuildDeps && rm -rf /var/lib/apt/lists/* 	&& ( 		export CATALINA_HOME="$PWD" 		&& cd "$nativeBuildDir/jni/native" 		&& ./configure 			--libdir=/usr/lib/jni 			--prefix="$CATALINA_HOME" 			--with-apr=/usr/bin/apr-1-config 			--with-java-home="$(docker-java-home)" 			--with-ssl=yes 		&& make -j$(nproc) 		&& make install 	) 	&& apt-get purge -y --auto-remove $nativeBuildDeps 	&& rm -rf "$nativeBuildDir" 	&& rm bin/tomcat-native.tar.gz
# Wed, 03 Aug 2016 20:21:26 GMT
EXPOSE 8080/tcp
# Wed, 03 Aug 2016 20:21:27 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:a7ad81be6b9312f0b4e6d6ef31c799b83a7fb1797e398d3c0d16d992c9552904`  
		...
		Size: 144.0 B
	-	`sha256:a164747d9ecf93622a7aa86b22b31cdcd15626205c44039e0c1a2bca3599da54`  
		Last Modified: Wed, 03 Aug 2016 20:21:41 GMT  
		Size: 222.4 KB (222430 bytes)
	-	`sha256:9c0ad750df99679fc66c893b044e2f4f44c1297c88e5939f80525312ed8cecaa`  
		Last Modified: Wed, 03 Aug 2016 20:21:40 GMT  
		Size: 266.2 KB (266211 bytes)
	-	`sha256:11aaba2452236b56cff03f7b7e6d5945202b57a55641a6d60028cc0a93f7d85a`  
		Last Modified: Wed, 03 Aug 2016 20:21:46 GMT  
		Size: 7.7 MB (7722425 bytes)
...
```console
$ docker pull tomcat@sha256:06b15dad76c937444c874622db14cab71775cb3b140d72a617b2322456d2af37
```

-	Platforms:
	-	linux; amd64

### `tomcat:7.0.70-jre7` - linux; amd64

-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.0 MB (160976673 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d90cd5c2490746c48cfc3889fee7a414bcd1eb1a1b78c3b7c4edb31f2cd08a7e`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 10 Jun 2016 23:16:44 GMT
WORKDIR /usr/local/tomcat
# Fri, 08 Jul 2016 19:59:39 GMT
ENV TOMCAT_NATIVE_LIBDIR=/usr/local/tomcat/native-jni-lib
# Fri, 08 Jul 2016 19:59:39 GMT
ENV LD_LIBRARY_PATH=/usr/local/tomcat/native-jni-lib
# Fri, 08 Jul 2016 19:59:40 GMT
ENV OPENSSL_VERSION=1.0.2h-1
# Fri, 08 Jul 2016 19:59:41 GMT
...
# Fri, 08 Jul 2016 20:03:13 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep 'INFO: Loaded APR based Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 08 Jul 2016 20:03:14 GMT
EXPOSE 8080/tcp
# Fri, 08 Jul 2016 20:03:14 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:227937ba18b624797eb802b93e01c27798b9ba5dea3c08bf76d6fa3a8dbb2934`  
		Last Modified: Wed, 15 Jun 2016 21:27:48 GMT  
		Size: 146.0 B
	-	`sha256:c901d3d8addffb59dded9bb0f852af94c6f6293923cb4502c135018944977a67`  
		Last Modified: Fri, 08 Jul 2016 20:20:20 GMT  
		Size: 334.0 B
	-	`sha256:d03cbd0396acb2f9b69b09f91d6423dbb4a7c31eb282aff4e7406d4d49cb19db`  
		Last Modified: Fri, 08 Jul 2016 20:20:21 GMT  
		Size: 3.0 MB (3015876 bytes)
	-	`sha256:3458b590f74c0bf03dcf70268ad43a300d28a3756ada05c9552ce397220183da`  
		Last Modified: Fri, 08 Jul 2016 20:20:20 GMT  
		Size: 106.1 KB (106132 bytes)
	-	`sha256:fe9be463e8ff49e11a02a078ce7b05dcf20fc6e32503d72df7809f11da113b4a`  
		Last Modified: Fri, 08 Jul 2016 20:20:22 GMT  
		Size: 9.7 MB (9730383 bytes)
	-	`sha256:1eefe0bd3d61c5c42e7e845278bd188904efb3f4eb124d55231de1f0805c556e`  
		Last Modified: Fri, 08 Jul 2016 20:20:21 GMT  
		Size: 129.0 B
...
```console
$ docker pull tomcat@sha256:18bf4c5f204fecc8cbd9855091066b85a4c39374c3eb06fda8059dbe8e8c23e2
```
...
-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **76.5 MB (76467059 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ffe5379d7563fe1754a1e8172e9b910235388889a5cea0623b2d2424ce83fbb7`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 08 Jul 2016 20:03:15 GMT
ENV CATALINA_HOME=/usr/local/tomcat
# Fri, 08 Jul 2016 20:03:16 GMT
ENV PATH=/usr/local/tomcat/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/lib/jvm/java-1.7-openjdk/jre/bin:/usr/lib/jvm/java-1.7-openjdk/bin
# Fri, 08 Jul 2016 20:03:18 GMT
RUN mkdir -p "$CATALINA_HOME"
# Fri, 08 Jul 2016 20:03:18 GMT
WORKDIR /usr/local/tomcat
# Fri, 08 Jul 2016 20:03:19 GMT
ENV TOMCAT_NATIVE_LIBDIR=/usr/local/tomcat/native-jni-lib
# Fri, 08 Jul 2016 20:03:19 GMT
ENV LD_LIBRARY_PATH=/usr/local/tomcat/native-jni-lib
# Fri, 08 Jul 2016 20:03:24 GMT
RUN apk add --no-cache gnupg
# Fri, 08 Jul 2016 20:03:41 GMT
RUN set -ex 	&& for key in 		05AB33110949707C93A279E3D3EFE6B686867BA6 		07E48665A34DCAFAE522E5E6266191C37C037D42 		47309207D818FFD8DCD3F83F1931D684307A10A5 		541FBE7D8F78B25E055DDEE13C370389288584E7 		61B832AC2F1C5A90F0F9B00A1C506407564C17A3 		713DA88BE50911535FE716F5208B0AB1D63011C7 		79F7026C690BAA50B92CD8B66A3AD3F4F22C4FED 		9BA44C2621385CB966EBA586F72C284D731FABEE 		A27677289986DB50844682F8ACB77FC2E86E29AC 		A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 		DCFD35E0BF8CA7344752DE8B6FB21E8933C60243 		F3A04C595DB5B6A5F1ECA43E3B7BBB100D811BBE 		F7DA48BB64BCB84ECBA7EE6935CD23C10D498E23 	; do 		gpg --keyserver ha.pool.sks-keyservers.net --recv-keys "$key"; 	done
# Fri, 08 Jul 2016 20:03:41 GMT
ENV TOMCAT_MAJOR=7
# Fri, 08 Jul 2016 20:03:42 GMT
ENV TOMCAT_VERSION=7.0.70
# Fri, 08 Jul 2016 20:03:43 GMT
ENV TOMCAT_TGZ_URL=https://www.apache.org/dist/tomcat/tomcat-7/v7.0.70/bin/apache-tomcat-7.0.70.tar.gz
# Fri, 08 Jul 2016 20:04:02 GMT
...
# Fri, 08 Jul 2016 20:04:05 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep 'INFO: Loaded APR based Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 08 Jul 2016 20:04:06 GMT
EXPOSE 8080/tcp
# Fri, 08 Jul 2016 20:04:07 GMT
CMD ["catalina.sh" "run"]
```
...
```console
$ docker pull tomcat@sha256:6059c57ffc84bb82b6eb8c330dcf71b75b40bc1164fe928135f2ec86506714dd
```

-	Platforms:
	-	linux; amd64

### `tomcat:7.0.70-jre8` - linux; amd64

-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **136.8 MB (136831611 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3bb31556ce8163fb5c68b651cd945b111994cb05a19da365f616b9a0f0e32c0`
-	Default Command: `["catalina.sh","run"]`
...
RUN set -ex 	&& for key in 		05AB33110949707C93A279E3D3EFE6B686867BA6 		07E48665A34DCAFAE522E5E6266191C37C037D42 		47309207D818FFD8DCD3F83F1931D684307A10A5 		541FBE7D8F78B25E055DDEE13C370389288584E7 		61B832AC2F1C5A90F0F9B00A1C506407564C17A3 		713DA88BE50911535FE716F5208B0AB1D63011C7 		79F7026C690BAA50B92CD8B66A3AD3F4F22C4FED 		9BA44C2621385CB966EBA586F72C284D731FABEE 		A27677289986DB50844682F8ACB77FC2E86E29AC 		A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 		DCFD35E0BF8CA7344752DE8B6FB21E8933C60243 		F3A04C595DB5B6A5F1ECA43E3B7BBB100D811BBE 		F7DA48BB64BCB84ECBA7EE6935CD23C10D498E23 	; do 		gpg --keyserver ha.pool.sks-keyservers.net --recv-keys "$key"; 	done
# Wed, 03 Aug 2016 20:23:21 GMT
ENV TOMCAT_MAJOR=7
# Wed, 03 Aug 2016 20:23:22 GMT
ENV TOMCAT_VERSION=7.0.70
# Wed, 03 Aug 2016 20:23:23 GMT
ENV TOMCAT_TGZ_URL=https://www.apache.org/dist/tomcat/tomcat-7/v7.0.70/bin/apache-tomcat-7.0.70.tar.gz
# Wed, 03 Aug 2016 20:25:46 GMT
RUN set -x 		&& wget -O tomcat.tar.gz "$TOMCAT_TGZ_URL" 	&& wget -O tomcat.tar.gz.asc "$TOMCAT_TGZ_URL.asc" 	&& gpg --batch --verify tomcat.tar.gz.asc tomcat.tar.gz 	&& tar -xvf tomcat.tar.gz --strip-components=1 	&& rm bin/*.bat 	&& rm tomcat.tar.gz* 		&& nativeBuildDir="$(mktemp -d)" 	&& tar -xvf bin/tomcat-native.tar.gz -C "$nativeBuildDir" --strip-components=1 	&& nativeBuildDeps=" 		gcc 		libapr1-dev 		libssl-dev 		make 		openjdk-${JAVA_VERSION%%[-~bu]*}-jdk=$JAVA_DEBIAN_VERSION 	" 	&& apt-get update && apt-get install -y --no-install-recommends $nativeBuildDeps && rm -rf /var/lib/apt/lists/* 	&& ( 		export CATALINA_HOME="$PWD" 		&& cd "$nativeBuildDir/native" 		&& ./configure 			--libdir="$TOMCAT_NATIVE_LIBDIR" 			--prefix="$CATALINA_HOME" 			--with-apr="$(which apr-1-config)" 			--with-java-home="$(docker-java-home)" 			--with-ssl=yes 		&& make -j$(nproc) 		&& make install 	) 	&& apt-get purge -y --auto-remove $nativeBuildDeps 	&& rm -rf "$nativeBuildDir" 	&& rm bin/tomcat-native.tar.gz
# Wed, 03 Aug 2016 20:25:50 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep 'INFO: Loaded APR based Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 03 Aug 2016 20:25:51 GMT
EXPOSE 8080/tcp
...
-	Layers:
	...
	-	`sha256:f66cc48e4cb8c3a4e9d90ffbefa45eb2a3634a2360ba089767c8d2f47255676e`  
		Last Modified: Wed, 03 Aug 2016 20:26:05 GMT  
		Size: 9.7 MB (9669566 bytes)
	-	`sha256:6eecdbc557104cd40bbf39f6b1c2679e89d5d7c6fee2152adce9eee9a82ab04e`  
		Last Modified: Wed, 03 Aug 2016 20:26:02 GMT  
		Size: 131.0 B
...
```console
$ docker pull tomcat@sha256:dc92e1fd138d611aed7d3a25da4109c1db686878503e85df811c9d27548d33bb
```

-	Platforms:
	-	linux; amd64

### `tomcat:7.0.70-jre8-alpine` - linux; amd64

-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.0 MB (56008230 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38512c6a4eb30fe8807b3325be916806153e0f114e9f701972090a2eb07379d6`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 08 Jul 2016 20:07:35 GMT
ENV CATALINA_HOME=/usr/local/tomcat
# Fri, 08 Jul 2016 20:07:36 GMT
ENV PATH=/usr/local/tomcat/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/lib/jvm/java-1.8-openjdk/jre/bin:/usr/lib/jvm/java-1.8-openjdk/bin
# Fri, 08 Jul 2016 20:07:37 GMT
RUN mkdir -p "$CATALINA_HOME"
# Fri, 08 Jul 2016 20:07:38 GMT
WORKDIR /usr/local/tomcat
# Fri, 08 Jul 2016 20:07:38 GMT
ENV TOMCAT_NATIVE_LIBDIR=/usr/local/tomcat/native-jni-lib
# Fri, 08 Jul 2016 20:07:39 GMT
ENV LD_LIBRARY_PATH=/usr/local/tomcat/native-jni-lib
# Fri, 08 Jul 2016 20:07:45 GMT
RUN apk add --no-cache gnupg
# Fri, 08 Jul 2016 20:07:54 GMT
RUN set -ex 	&& for key in 		05AB33110949707C93A279E3D3EFE6B686867BA6 		07E48665A34DCAFAE522E5E6266191C37C037D42 		47309207D818FFD8DCD3F83F1931D684307A10A5 		541FBE7D8F78B25E055DDEE13C370389288584E7 		61B832AC2F1C5A90F0F9B00A1C506407564C17A3 		713DA88BE50911535FE716F5208B0AB1D63011C7 		79F7026C690BAA50B92CD8B66A3AD3F4F22C4FED 		9BA44C2621385CB966EBA586F72C284D731FABEE 		A27677289986DB50844682F8ACB77FC2E86E29AC 		A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 		DCFD35E0BF8CA7344752DE8B6FB21E8933C60243 		F3A04C595DB5B6A5F1ECA43E3B7BBB100D811BBE 		F7DA48BB64BCB84ECBA7EE6935CD23C10D498E23 	; do 		gpg --keyserver ha.pool.sks-keyservers.net --recv-keys "$key"; 	done
# Fri, 08 Jul 2016 20:07:55 GMT
ENV TOMCAT_MAJOR=7
# Fri, 08 Jul 2016 20:07:55 GMT
ENV TOMCAT_VERSION=7.0.70
# Fri, 08 Jul 2016 20:07:56 GMT
ENV TOMCAT_TGZ_URL=https://www.apache.org/dist/tomcat/tomcat-7/v7.0.70/bin/apache-tomcat-7.0.70.tar.gz
# Fri, 08 Jul 2016 20:08:17 GMT
RUN set -x 		&& apk add --no-cache --virtual .fetch-deps 		ca-certificates 		tar 		openssl 	&& wget -O tomcat.tar.gz "$TOMCAT_TGZ_URL" 	&& wget -O tomcat.tar.gz.asc "$TOMCAT_TGZ_URL.asc" 	&& gpg --batch --verify tomcat.tar.gz.asc tomcat.tar.gz 	&& tar -xvf tomcat.tar.gz --strip-components=1 	&& rm bin/*.bat 	&& rm tomcat.tar.gz* 		&& nativeBuildDir="$(mktemp -d)" 	&& tar -xvf bin/tomcat-native.tar.gz -C "$nativeBuildDir" --strip-components=1 	&& apk add --no-cache --virtual .native-build-deps 		apr-dev 		gcc 		libc-dev 		make 		"openjdk${JAVA_VERSION%%[-~bu]*}"="$JAVA_ALPINE_VERSION" 		openssl-dev 	&& ( 		export CATALINA_HOME="$PWD" 		&& cd "$nativeBuildDir/native" 		&& ./configure 			--libdir="$TOMCAT_NATIVE_LIBDIR" 			--prefix="$CATALINA_HOME" 			--with-apr="$(which apr-1-config)" 			--with-java-home="$(docker-java-home)" 			--with-ssl=yes 		&& make -j$(getconf _NPROCESSORS_ONLN) 		&& make install 	) 	&& runDeps="$( 		scanelf --needed --nobanner --recursive "$TOMCAT_NATIVE_LIBDIR" 			| awk '{ gsub(/,/, "\nso:", $2); print "so:" $2 }' 			| sort -u 			| xargs -r apk info --installed 			| sort -u 	)" 	&& apk add --virtual .tomcat-native-rundeps $runDeps 	&& apk del .fetch-deps .native-build-deps 	&& rm -rf "$nativeBuildDir" 	&& rm bin/tomcat-native.tar.gz
# Fri, 08 Jul 2016 20:08:19 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep 'INFO: Loaded APR based Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 08 Jul 2016 20:08:20 GMT
EXPOSE 8080/tcp
# Fri, 08 Jul 2016 20:08:20 GMT
CMD ["catalina.sh" "run"]
```
...
```console
$ docker pull tomcat@sha256:0a896f996782bd22756f342784738fdfdc5d6ca5a284b53d289e257eef1538fa
```
...
-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.3 MB (161320442 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:25e98610c7d0ce3c3cf05a6d8b3e932135d86720f1d46e73a49a8256eca27892`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 08 Jul 2016 20:01:00 GMT
RUN set -ex 	&& for key in 		05AB33110949707C93A279E3D3EFE6B686867BA6 		07E48665A34DCAFAE522E5E6266191C37C037D42 		47309207D818FFD8DCD3F83F1931D684307A10A5 		541FBE7D8F78B25E055DDEE13C370389288584E7 		61B832AC2F1C5A90F0F9B00A1C506407564C17A3 		713DA88BE50911535FE716F5208B0AB1D63011C7 		79F7026C690BAA50B92CD8B66A3AD3F4F22C4FED 		9BA44C2621385CB966EBA586F72C284D731FABEE 		A27677289986DB50844682F8ACB77FC2E86E29AC 		A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 		DCFD35E0BF8CA7344752DE8B6FB21E8933C60243 		F3A04C595DB5B6A5F1ECA43E3B7BBB100D811BBE 		F7DA48BB64BCB84ECBA7EE6935CD23C10D498E23 	; do 		gpg --keyserver ha.pool.sks-keyservers.net --recv-keys "$key"; 	done
# Fri, 08 Jul 2016 20:08:21 GMT
ENV TOMCAT_MAJOR=8
# Fri, 08 Jul 2016 20:08:21 GMT
ENV TOMCAT_VERSION=8.0.36
# Fri, 08 Jul 2016 20:08:22 GMT
ENV TOMCAT_TGZ_URL=https://www.apache.org/dist/tomcat/tomcat-8/v8.0.36/bin/apache-tomcat-8.0.36.tar.gz
# Fri, 08 Jul 2016 20:10:18 GMT
RUN set -x 		&& wget -O tomcat.tar.gz "$TOMCAT_TGZ_URL" 	&& wget -O tomcat.tar.gz.asc "$TOMCAT_TGZ_URL.asc" 	&& gpg --batch --verify tomcat.tar.gz.asc tomcat.tar.gz 	&& tar -xvf tomcat.tar.gz --strip-components=1 	&& rm bin/*.bat 	&& rm tomcat.tar.gz* 		&& nativeBuildDir="$(mktemp -d)" 	&& tar -xvf bin/tomcat-native.tar.gz -C "$nativeBuildDir" --strip-components=1 	&& nativeBuildDeps=" 		gcc 		libapr1-dev 		libssl-dev 		make 		openjdk-${JAVA_VERSION%%[-~bu]*}-jdk=$JAVA_DEBIAN_VERSION 	" 	&& apt-get update && apt-get install -y --no-install-recommends $nativeBuildDeps && rm -rf /var/lib/apt/lists/* 	&& ( 		export CATALINA_HOME="$PWD" 		&& cd "$nativeBuildDir/native" 		&& ./configure 			--libdir="$TOMCAT_NATIVE_LIBDIR" 			--prefix="$CATALINA_HOME" 			--with-apr="$(which apr-1-config)" 			--with-java-home="$(docker-java-home)" 			--with-ssl=yes 		&& make -j$(nproc) 		&& make install 	) 	&& apt-get purge -y --auto-remove $nativeBuildDeps 	&& rm -rf "$nativeBuildDir" 	&& rm bin/tomcat-native.tar.gz
# Fri, 08 Jul 2016 20:10:20 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep 'INFO: Loaded APR based Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 08 Jul 2016 20:10:21 GMT
EXPOSE 8080/tcp
# Fri, 08 Jul 2016 20:10:21 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:3458b590f74c0bf03dcf70268ad43a300d28a3756ada05c9552ce397220183da`  
		Last Modified: Fri, 08 Jul 2016 20:20:20 GMT  
		Size: 106.1 KB (106132 bytes)
	-	`sha256:0c89b2cad97c2a4b76862f029081ead9affda53a4c8c599f3d92987589a7687f`  
		Last Modified: Fri, 08 Jul 2016 20:23:42 GMT  
		Size: 10.1 MB (10074151 bytes)
	-	`sha256:ffe428bc6429b4a693aacffe3cdf57c5231733fd688a14c51776b6b6544fe399`  
		Last Modified: Fri, 08 Jul 2016 20:23:40 GMT  
		Size: 130.0 B
...
```console
$ docker pull tomcat@sha256:e8c52899c0795ef4201488e869f7a4a84764e3f5ae2e8a038c67b0152d982440
```

-	Platforms:
	-	linux; amd64

### `tomcat:8.0.36-jre7-alpine` - linux; amd64

-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **76.8 MB (76822022 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6aa1f69661d4a6d5a68c3318eee61ad0ab6d3cdf3123d91c4a46e759214e1a2`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 08 Jul 2016 20:03:41 GMT
RUN set -ex 	&& for key in 		05AB33110949707C93A279E3D3EFE6B686867BA6 		07E48665A34DCAFAE522E5E6266191C37C037D42 		47309207D818FFD8DCD3F83F1931D684307A10A5 		541FBE7D8F78B25E055DDEE13C370389288584E7 		61B832AC2F1C5A90F0F9B00A1C506407564C17A3 		713DA88BE50911535FE716F5208B0AB1D63011C7 		79F7026C690BAA50B92CD8B66A3AD3F4F22C4FED 		9BA44C2621385CB966EBA586F72C284D731FABEE 		A27677289986DB50844682F8ACB77FC2E86E29AC 		A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 		DCFD35E0BF8CA7344752DE8B6FB21E8933C60243 		F3A04C595DB5B6A5F1ECA43E3B7BBB100D811BBE 		F7DA48BB64BCB84ECBA7EE6935CD23C10D498E23 	; do 		gpg --keyserver ha.pool.sks-keyservers.net --recv-keys "$key"; 	done
# Fri, 08 Jul 2016 20:10:22 GMT
ENV TOMCAT_MAJOR=8
# Fri, 08 Jul 2016 20:10:22 GMT
ENV TOMCAT_VERSION=8.0.36
# Fri, 08 Jul 2016 20:10:23 GMT
ENV TOMCAT_TGZ_URL=https://www.apache.org/dist/tomcat/tomcat-8/v8.0.36/bin/apache-tomcat-8.0.36.tar.gz
# Fri, 08 Jul 2016 20:10:45 GMT
RUN set -x 		&& apk add --no-cache --virtual .fetch-deps 		ca-certificates 		tar 		openssl 	&& wget -O tomcat.tar.gz "$TOMCAT_TGZ_URL" 	&& wget -O tomcat.tar.gz.asc "$TOMCAT_TGZ_URL.asc" 	&& gpg --batch --verify tomcat.tar.gz.asc tomcat.tar.gz 	&& tar -xvf tomcat.tar.gz --strip-components=1 	&& rm bin/*.bat 	&& rm tomcat.tar.gz* 		&& nativeBuildDir="$(mktemp -d)" 	&& tar -xvf bin/tomcat-native.tar.gz -C "$nativeBuildDir" --strip-components=1 	&& apk add --no-cache --virtual .native-build-deps 		apr-dev 		gcc 		libc-dev 		make 		"openjdk${JAVA_VERSION%%[-~bu]*}"="$JAVA_ALPINE_VERSION" 		openssl-dev 	&& ( 		export CATALINA_HOME="$PWD" 		&& cd "$nativeBuildDir/native" 		&& ./configure 			--libdir="$TOMCAT_NATIVE_LIBDIR" 			--prefix="$CATALINA_HOME" 			--with-apr="$(which apr-1-config)" 			--with-java-home="$(docker-java-home)" 			--with-ssl=yes 		&& make -j$(getconf _NPROCESSORS_ONLN) 		&& make install 	) 	&& runDeps="$( 		scanelf --needed --nobanner --recursive "$TOMCAT_NATIVE_LIBDIR" 			| awk '{ gsub(/,/, "\nso:", $2); print "so:" $2 }' 			| sort -u 			| xargs -r apk info --installed 			| sort -u 	)" 	&& apk add --virtual .tomcat-native-rundeps $runDeps 	&& apk del .fetch-deps .native-build-deps 	&& rm -rf "$nativeBuildDir" 	&& rm bin/tomcat-native.tar.gz
# Fri, 08 Jul 2016 20:10:47 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep 'INFO: Loaded APR based Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 08 Jul 2016 20:10:47 GMT
EXPOSE 8080/tcp
# Fri, 08 Jul 2016 20:10:48 GMT
CMD ["catalina.sh" "run"]
```
...
### `tomcat:8.0.36-alpine` - linux; amd64
...
```console
$ docker pull tomcat@sha256:25d3daef1408fb565ff9c524f49cec7316f576a28cd797af9b994a44c5109f38
```
...
-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.2 MB (137184574 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8eb221fb7331c7a59486558af881ea0348be4bbb20ac6196bad983a0aa0b1fb9`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 02 Aug 2016 00:04:56 GMT
ENV TOMCAT_MAJOR=8
# Tue, 02 Aug 2016 00:04:57 GMT
ENV TOMCAT_VERSION=8.0.36
# Tue, 02 Aug 2016 00:04:58 GMT
ENV TOMCAT_TGZ_URL=https://www.apache.org/dist/tomcat/tomcat-8/v8.0.36/bin/apache-tomcat-8.0.36.tar.gz
# Tue, 02 Aug 2016 16:50:03 GMT
RUN set -x 		&& wget -O tomcat.tar.gz "$TOMCAT_TGZ_URL" 	&& wget -O tomcat.tar.gz.asc "$TOMCAT_TGZ_URL.asc" 	&& gpg --batch --verify tomcat.tar.gz.asc tomcat.tar.gz 	&& tar -xvf tomcat.tar.gz --strip-components=1 	&& rm bin/*.bat 	&& rm tomcat.tar.gz* 		&& nativeBuildDir="$(mktemp -d)" 	&& tar -xvf bin/tomcat-native.tar.gz -C "$nativeBuildDir" --strip-components=1 	&& nativeBuildDeps=" 		gcc 		libapr1-dev 		libssl-dev 		make 		openjdk-${JAVA_VERSION%%[-~bu]*}-jdk=$JAVA_DEBIAN_VERSION 	" 	&& apt-get update && apt-get install -y --no-install-recommends $nativeBuildDeps && rm -rf /var/lib/apt/lists/* 	&& ( 		export CATALINA_HOME="$PWD" 		&& cd "$nativeBuildDir/native" 		&& ./configure 			--libdir="$TOMCAT_NATIVE_LIBDIR" 			--prefix="$CATALINA_HOME" 			--with-apr="$(which apr-1-config)" 			--with-java-home="$(docker-java-home)" 			--with-ssl=yes 		&& make -j$(nproc) 		&& make install 	) 	&& apt-get purge -y --auto-remove $nativeBuildDeps 	&& rm -rf "$nativeBuildDir" 	&& rm bin/tomcat-native.tar.gz
# Tue, 02 Aug 2016 16:50:07 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep 'INFO: Loaded APR based Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Tue, 02 Aug 2016 16:50:07 GMT
EXPOSE 8080/tcp
# Tue, 02 Aug 2016 16:50:08 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:e40c8fcfbfa2d03a1db9c68970ef4d5a0fbc3320f96a11b172674789913b8e43`  
		Last Modified: Tue, 02 Aug 2016 16:50:19 GMT  
		Size: 107.2 KB (107242 bytes)
	-	`sha256:06ad472cf72f1133a351c83115c1aae247de99eee37cce6ada8355d9d5e3e8cb`  
		Last Modified: Tue, 02 Aug 2016 16:50:21 GMT  
		Size: 10.0 MB (10022529 bytes)
	-	`sha256:ca39bf7d5b05c2fa0b8e4e9b793e790728ad1fe572591d9a14d80b3e17d45c6b`  
		Last Modified: Tue, 02 Aug 2016 16:50:19 GMT  
		Size: 131.0 B
...
```console
$ docker pull tomcat@sha256:1a2b582085cd4541bfd6d2ab40016be0c5b35c0e2926adf8284435d6c1fe81b8
```

-	Platforms:
	-	linux; amd64

### `tomcat:8.0.36-jre8-alpine` - linux; amd64

-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.4 MB (56365823 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b0ca4b09f74556a997ab35150b7995cd722a3d5aa98255404684341b8a5cd6a9`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 08 Jul 2016 20:07:54 GMT
RUN set -ex 	&& for key in 		05AB33110949707C93A279E3D3EFE6B686867BA6 		07E48665A34DCAFAE522E5E6266191C37C037D42 		47309207D818FFD8DCD3F83F1931D684307A10A5 		541FBE7D8F78B25E055DDEE13C370389288584E7 		61B832AC2F1C5A90F0F9B00A1C506407564C17A3 		713DA88BE50911535FE716F5208B0AB1D63011C7 		79F7026C690BAA50B92CD8B66A3AD3F4F22C4FED 		9BA44C2621385CB966EBA586F72C284D731FABEE 		A27677289986DB50844682F8ACB77FC2E86E29AC 		A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 		DCFD35E0BF8CA7344752DE8B6FB21E8933C60243 		F3A04C595DB5B6A5F1ECA43E3B7BBB100D811BBE 		F7DA48BB64BCB84ECBA7EE6935CD23C10D498E23 	; do 		gpg --keyserver ha.pool.sks-keyservers.net --recv-keys "$key"; 	done
# Fri, 08 Jul 2016 20:13:05 GMT
ENV TOMCAT_MAJOR=8
# Fri, 08 Jul 2016 20:13:06 GMT
ENV TOMCAT_VERSION=8.0.36
# Fri, 08 Jul 2016 20:13:06 GMT
ENV TOMCAT_TGZ_URL=https://www.apache.org/dist/tomcat/tomcat-8/v8.0.36/bin/apache-tomcat-8.0.36.tar.gz
# Fri, 08 Jul 2016 20:13:24 GMT
RUN set -x 		&& apk add --no-cache --virtual .fetch-deps 		ca-certificates 		tar 		openssl 	&& wget -O tomcat.tar.gz "$TOMCAT_TGZ_URL" 	&& wget -O tomcat.tar.gz.asc "$TOMCAT_TGZ_URL.asc" 	&& gpg --batch --verify tomcat.tar.gz.asc tomcat.tar.gz 	&& tar -xvf tomcat.tar.gz --strip-components=1 	&& rm bin/*.bat 	&& rm tomcat.tar.gz* 		&& nativeBuildDir="$(mktemp -d)" 	&& tar -xvf bin/tomcat-native.tar.gz -C "$nativeBuildDir" --strip-components=1 	&& apk add --no-cache --virtual .native-build-deps 		apr-dev 		gcc 		libc-dev 		make 		"openjdk${JAVA_VERSION%%[-~bu]*}"="$JAVA_ALPINE_VERSION" 		openssl-dev 	&& ( 		export CATALINA_HOME="$PWD" 		&& cd "$nativeBuildDir/native" 		&& ./configure 			--libdir="$TOMCAT_NATIVE_LIBDIR" 			--prefix="$CATALINA_HOME" 			--with-apr="$(which apr-1-config)" 			--with-java-home="$(docker-java-home)" 			--with-ssl=yes 		&& make -j$(getconf _NPROCESSORS_ONLN) 		&& make install 	) 	&& runDeps="$( 		scanelf --needed --nobanner --recursive "$TOMCAT_NATIVE_LIBDIR" 			| awk '{ gsub(/,/, "\nso:", $2); print "so:" $2 }' 			| sort -u 			| xargs -r apk info --installed 			| sort -u 	)" 	&& apk add --virtual .tomcat-native-rundeps $runDeps 	&& apk del .fetch-deps .native-build-deps 	&& rm -rf "$nativeBuildDir" 	&& rm bin/tomcat-native.tar.gz
# Fri, 08 Jul 2016 20:13:27 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep 'INFO: Loaded APR based Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Fri, 08 Jul 2016 20:13:27 GMT
EXPOSE 8080/tcp
# Fri, 08 Jul 2016 20:13:27 GMT
...
```console
$ docker pull tomcat@sha256:1adbbf78f7fae48233d3734905152fe1fec3a43a0cdc64dc926a71ecb2744809
```

-	Platforms:
	-	linux; amd64

### `tomcat:8.5.4-jre8` - linux; amd64

-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.3 MB (137282740 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:647c495293de693e69692e3f2e4851a5e279afe038c4b3c080fbc1569ba9aef7`
-	Default Command: `["catalina.sh","run"]`
...
RUN set -ex 	&& for key in 		05AB33110949707C93A279E3D3EFE6B686867BA6 		07E48665A34DCAFAE522E5E6266191C37C037D42 		47309207D818FFD8DCD3F83F1931D684307A10A5 		541FBE7D8F78B25E055DDEE13C370389288584E7 		61B832AC2F1C5A90F0F9B00A1C506407564C17A3 		713DA88BE50911535FE716F5208B0AB1D63011C7 		79F7026C690BAA50B92CD8B66A3AD3F4F22C4FED 		9BA44C2621385CB966EBA586F72C284D731FABEE 		A27677289986DB50844682F8ACB77FC2E86E29AC 		A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 		DCFD35E0BF8CA7344752DE8B6FB21E8933C60243 		F3A04C595DB5B6A5F1ECA43E3B7BBB100D811BBE 		F7DA48BB64BCB84ECBA7EE6935CD23C10D498E23 	; do 		gpg --keyserver ha.pool.sks-keyservers.net --recv-keys "$key"; 	done
# Fri, 08 Jul 2016 20:10:49 GMT
ENV TOMCAT_MAJOR=8
# Thu, 14 Jul 2016 02:41:16 GMT
...
# Thu, 14 Jul 2016 02:43:25 GMT
RUN set -x 		&& wget -O tomcat.tar.gz "$TOMCAT_TGZ_URL" 	&& wget -O tomcat.tar.gz.asc "$TOMCAT_TGZ_URL.asc" 	&& gpg --batch --verify tomcat.tar.gz.asc tomcat.tar.gz 	&& tar -xvf tomcat.tar.gz --strip-components=1 	&& rm bin/*.bat 	&& rm tomcat.tar.gz* 		&& nativeBuildDir="$(mktemp -d)" 	&& tar -xvf bin/tomcat-native.tar.gz -C "$nativeBuildDir" --strip-components=1 	&& nativeBuildDeps=" 		gcc 		libapr1-dev 		libssl-dev 		make 		openjdk-${JAVA_VERSION%%[-~bu]*}-jdk=$JAVA_DEBIAN_VERSION 	" 	&& apt-get update && apt-get install -y --no-install-recommends $nativeBuildDeps && rm -rf /var/lib/apt/lists/* 	&& ( 		export CATALINA_HOME="$PWD" 		&& cd "$nativeBuildDir/native" 		&& ./configure 			--libdir="$TOMCAT_NATIVE_LIBDIR" 			--prefix="$CATALINA_HOME" 			--with-apr="$(which apr-1-config)" 			--with-java-home="$(docker-java-home)" 			--with-ssl=yes 		&& make -j$(nproc) 		&& make install 	) 	&& apt-get purge -y --auto-remove $nativeBuildDeps 	&& rm -rf "$nativeBuildDir" 	&& rm bin/tomcat-native.tar.gz
# Thu, 14 Jul 2016 02:43:28 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep 'INFO: Loaded APR based Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 14 Jul 2016 02:43:29 GMT
EXPOSE 8080/tcp
# Thu, 14 Jul 2016 02:43:30 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:74b0dba450b99f48fb339878ecb1eff00027a1f1d78969052a9ca3d2d96ccbef`  
		Last Modified: Thu, 14 Jul 2016 02:54:33 GMT  
		Size: 10.0 MB (10049572 bytes)
	-	`sha256:e56e9713346c116df6bba5ef224db1a0a6c7d18f184b82b5ad2bd8b5c083c476`  
		Last Modified: Thu, 14 Jul 2016 02:54:31 GMT  
		Size: 133.0 B

## `tomcat:8.5-jre8`

```console
$ docker pull tomcat@sha256:53ddf369737cd2e38c894c3237ba7617d32ee863abfdf6c462f4b5f05be07f1a
```
...
-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.2 MB (137181099 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9eedf91f6e9e02ac14fb7eb4d599a77c81cf47c6c4c82aed282e76c98ad14f29`
-	Default Command: `["catalina.sh","run"]`
...
# Tue, 02 Aug 2016 00:04:56 GMT
ENV TOMCAT_MAJOR=8
# Tue, 02 Aug 2016 16:51:03 GMT
ENV TOMCAT_VERSION=8.5.4
# Tue, 02 Aug 2016 16:51:04 GMT
ENV TOMCAT_TGZ_URL=https://www.apache.org/dist/tomcat/tomcat-8/v8.5.4/bin/apache-tomcat-8.5.4.tar.gz
# Wed, 03 Aug 2016 20:12:10 GMT
RUN set -x 		&& wget -O tomcat.tar.gz "$TOMCAT_TGZ_URL" 	&& wget -O tomcat.tar.gz.asc "$TOMCAT_TGZ_URL.asc" 	&& gpg --batch --verify tomcat.tar.gz.asc tomcat.tar.gz 	&& tar -xvf tomcat.tar.gz --strip-components=1 	&& rm bin/*.bat 	&& rm tomcat.tar.gz* 		&& nativeBuildDir="$(mktemp -d)" 	&& tar -xvf bin/tomcat-native.tar.gz -C "$nativeBuildDir" --strip-components=1 	&& nativeBuildDeps=" 		gcc 		libapr1-dev 		libssl-dev 		make 		openjdk-${JAVA_VERSION%%[-~bu]*}-jdk=$JAVA_DEBIAN_VERSION 	" 	&& apt-get update && apt-get install -y --no-install-recommends $nativeBuildDeps && rm -rf /var/lib/apt/lists/* 	&& ( 		export CATALINA_HOME="$PWD" 		&& cd "$nativeBuildDir/native" 		&& ./configure 			--libdir="$TOMCAT_NATIVE_LIBDIR" 			--prefix="$CATALINA_HOME" 			--with-apr="$(which apr-1-config)" 			--with-java-home="$(docker-java-home)" 			--with-ssl=yes 		&& make -j$(nproc) 		&& make install 	) 	&& apt-get purge -y --auto-remove $nativeBuildDeps 	&& rm -rf "$nativeBuildDir" 	&& rm bin/tomcat-native.tar.gz
# Wed, 03 Aug 2016 20:12:12 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep 'INFO: Loaded APR based Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Wed, 03 Aug 2016 20:12:12 GMT
EXPOSE 8080/tcp
# Wed, 03 Aug 2016 20:12:13 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:e40c8fcfbfa2d03a1db9c68970ef4d5a0fbc3320f96a11b172674789913b8e43`  
		Last Modified: Tue, 02 Aug 2016 16:50:19 GMT  
		Size: 107.2 KB (107242 bytes)
	-	`sha256:71244efd374c4f6391013211482ea4dd48bbf163bef68b74d904870c83ec2c82`  
		Last Modified: Wed, 03 Aug 2016 20:12:27 GMT  
		Size: 10.0 MB (10019054 bytes)
	-	`sha256:e984802ddaa77a7fa7dd84088e3239ae98b28e5f0e1c4e655c49d18f8e9b5ac8`  
		Last Modified: Wed, 03 Aug 2016 20:12:24 GMT  
		Size: 131.0 B
...
```console
$ docker pull tomcat@sha256:b076b1c5838833c6288f1ccde4979445cb18072a0c7cf5bc3d6c12f1d6d292dc
```

-	Platforms:
	-	linux; amd64

### `tomcat:8.5.4-jre8-alpine` - linux; amd64

-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.4 MB (56364154 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f5c7ecb437e6d499f409e1a26b3c77f3cd0386c3f21f9870bb6ba99c462b6c8`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 08 Jul 2016 20:13:05 GMT
ENV TOMCAT_MAJOR=8
# Thu, 14 Jul 2016 02:43:31 GMT
ENV TOMCAT_VERSION=8.5.4
# Thu, 14 Jul 2016 02:43:32 GMT
ENV TOMCAT_TGZ_URL=https://www.apache.org/dist/tomcat/tomcat-8/v8.5.4/bin/apache-tomcat-8.5.4.tar.gz
# Thu, 14 Jul 2016 02:43:53 GMT
RUN set -x 		&& apk add --no-cache --virtual .fetch-deps 		ca-certificates 		tar 		openssl 	&& wget -O tomcat.tar.gz "$TOMCAT_TGZ_URL" 	&& wget -O tomcat.tar.gz.asc "$TOMCAT_TGZ_URL.asc" 	&& gpg --batch --verify tomcat.tar.gz.asc tomcat.tar.gz 	&& tar -xvf tomcat.tar.gz --strip-components=1 	&& rm bin/*.bat 	&& rm tomcat.tar.gz* 		&& nativeBuildDir="$(mktemp -d)" 	&& tar -xvf bin/tomcat-native.tar.gz -C "$nativeBuildDir" --strip-components=1 	&& apk add --no-cache --virtual .native-build-deps 		apr-dev 		gcc 		libc-dev 		make 		"openjdk${JAVA_VERSION%%[-~bu]*}"="$JAVA_ALPINE_VERSION" 		openssl-dev 	&& ( 		export CATALINA_HOME="$PWD" 		&& cd "$nativeBuildDir/native" 		&& ./configure 			--libdir="$TOMCAT_NATIVE_LIBDIR" 			--prefix="$CATALINA_HOME" 			--with-apr="$(which apr-1-config)" 			--with-java-home="$(docker-java-home)" 			--with-ssl=yes 		&& make -j$(getconf _NPROCESSORS_ONLN) 		&& make install 	) 	&& runDeps="$( 		scanelf --needed --nobanner --recursive "$TOMCAT_NATIVE_LIBDIR" 			| awk '{ gsub(/,/, "\nso:", $2); print "so:" $2 }' 			| sort -u 			| xargs -r apk info --installed 			| sort -u 	)" 	&& apk add --virtual .tomcat-native-rundeps $runDeps 	&& apk del .fetch-deps .native-build-deps 	&& rm -rf "$nativeBuildDir" 	&& rm bin/tomcat-native.tar.gz
# Thu, 14 Jul 2016 02:43:56 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep 'INFO: Loaded APR based Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 14 Jul 2016 02:43:57 GMT
EXPOSE 8080/tcp
# Thu, 14 Jul 2016 02:43:58 GMT
CMD ["catalina.sh" "run"]
```
...
### `tomcat:8.5.4-alpine` - linux; amd64
...
### `tomcat:9.0.0.M9-jre8` - linux; amd64
...
```console
$ docker pull tomcat@sha256:006dbf80a84e9bc5eb3d45eacddf078540ce2ec5422e326834f287bd01a2a6c5
```

-	Platforms:
	-	linux; amd64

### `tomcat:9.0.0.M9-jre8-alpine` - linux; amd64

-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.4 MB (56407638 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e1d5388b1f1256ee5a1a8cec59a9e135fb5614fae952fe32af0fb12d0ce0dbb2`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 08 Jul 2016 20:07:54 GMT
RUN set -ex 	&& for key in 		05AB33110949707C93A279E3D3EFE6B686867BA6 		07E48665A34DCAFAE522E5E6266191C37C037D42 		47309207D818FFD8DCD3F83F1931D684307A10A5 		541FBE7D8F78B25E055DDEE13C370389288584E7 		61B832AC2F1C5A90F0F9B00A1C506407564C17A3 		713DA88BE50911535FE716F5208B0AB1D63011C7 		79F7026C690BAA50B92CD8B66A3AD3F4F22C4FED 		9BA44C2621385CB966EBA586F72C284D731FABEE 		A27677289986DB50844682F8ACB77FC2E86E29AC 		A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 		DCFD35E0BF8CA7344752DE8B6FB21E8933C60243 		F3A04C595DB5B6A5F1ECA43E3B7BBB100D811BBE 		F7DA48BB64BCB84ECBA7EE6935CD23C10D498E23 	; do 		gpg --keyserver ha.pool.sks-keyservers.net --recv-keys "$key"; 	done
# Fri, 08 Jul 2016 20:18:26 GMT
ENV TOMCAT_MAJOR=9
# Thu, 14 Jul 2016 02:46:13 GMT
ENV TOMCAT_VERSION=9.0.0.M9
# Thu, 14 Jul 2016 02:46:14 GMT
ENV TOMCAT_TGZ_URL=https://www.apache.org/dist/tomcat/tomcat-9/v9.0.0.M9/bin/apache-tomcat-9.0.0.M9.tar.gz
# Thu, 14 Jul 2016 02:46:34 GMT
RUN set -x 		&& apk add --no-cache --virtual .fetch-deps 		ca-certificates 		tar 		openssl 	&& wget -O tomcat.tar.gz "$TOMCAT_TGZ_URL" 	&& wget -O tomcat.tar.gz.asc "$TOMCAT_TGZ_URL.asc" 	&& gpg --batch --verify tomcat.tar.gz.asc tomcat.tar.gz 	&& tar -xvf tomcat.tar.gz --strip-components=1 	&& rm bin/*.bat 	&& rm tomcat.tar.gz* 		&& nativeBuildDir="$(mktemp -d)" 	&& tar -xvf bin/tomcat-native.tar.gz -C "$nativeBuildDir" --strip-components=1 	&& apk add --no-cache --virtual .native-build-deps 		apr-dev 		gcc 		libc-dev 		make 		"openjdk${JAVA_VERSION%%[-~bu]*}"="$JAVA_ALPINE_VERSION" 		openssl-dev 	&& ( 		export CATALINA_HOME="$PWD" 		&& cd "$nativeBuildDir/native" 		&& ./configure 			--libdir="$TOMCAT_NATIVE_LIBDIR" 			--prefix="$CATALINA_HOME" 			--with-apr="$(which apr-1-config)" 			--with-java-home="$(docker-java-home)" 			--with-ssl=yes 		&& make -j$(getconf _NPROCESSORS_ONLN) 		&& make install 	) 	&& runDeps="$( 		scanelf --needed --nobanner --recursive "$TOMCAT_NATIVE_LIBDIR" 			| awk '{ gsub(/,/, "\nso:", $2); print "so:" $2 }' 			| sort -u 			| xargs -r apk info --installed 			| sort -u 	)" 	&& apk add --virtual .tomcat-native-rundeps $runDeps 	&& apk del .fetch-deps .native-build-deps 	&& rm -rf "$nativeBuildDir" 	&& rm bin/tomcat-native.tar.gz
# Thu, 14 Jul 2016 02:46:37 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep 'INFO: Loaded APR based Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 14 Jul 2016 02:46:38 GMT
EXPOSE 8080/tcp
# Thu, 14 Jul 2016 02:46:38 GMT
CMD ["catalina.sh" "run"]
```
...
### `tomcat:9.0.0.M9-alpine` - linux; amd64
