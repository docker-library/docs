...
To disable this image behavior, simply override the container command or entrypoint to run `dockerd` directly (`... i386/docker:dind dockerd ...` or `... --entrypoint dockerd i386/docker:dind ...`).
