...
To disable this image behavior, simply override the container command or entrypoint to run `dockerd` directly (`... mips64le/docker:dind dockerd ...` or `... --entrypoint dockerd mips64le/docker:dind ...`).
