...
To disable this image behavior, simply override the container command or entrypoint to run `dockerd` directly (`... riscv64/docker:dind dockerd ...` or `... --entrypoint dockerd riscv64/docker:dind ...`).
