...
-	[`1.12.0-rc2`, `1.12-rc`, `rc` (*1.12-rc/Dockerfile*)](https://github.com/docker-library/docker/blob/99287145029122cf49321fa2a055d14240001d1d/1.12-rc/Dockerfile)
-	[`1.12.0-rc2-dind`, `1.12-rc-dind`, `rc-dind` (*1.12-rc/dind/Dockerfile*)](https://github.com/docker-library/docker/blob/4d1f83ee6e25a5c2bb1c8a04de0643b1a964ba5e/1.12-rc/dind/Dockerfile)
-	[`1.12.0-rc2-git`, `1.12-rc-git`, `rc-git` (*1.12-rc/git/Dockerfile*)](https://github.com/docker-library/docker/blob/4d1f83ee6e25a5c2bb1c8a04de0643b1a964ba5e/1.12-rc/git/Dockerfile)
...
-	[`1.11.2-dind`, `1.11-dind`, `1-dind`, `dind` (*1.11/dind/Dockerfile*)](https://github.com/docker-library/docker/blob/866c3fbd87e8eeed524fdf19ba2d63288ad49cd2/1.11/dind/Dockerfile)
...
[![](https://badge.imagelayers.io/docker:latest.svg)](https://imagelayers.io/?images=docker:1.12.0-rc2,docker:1.12.0-rc2-dind,docker:1.12.0-rc2-git,docker:1.11.2,docker:1.11.2-dind,docker:1.11.2-git,docker:1.10.3,docker:1.10.3-dind,docker:1.10.3-git)
