...
To disable this image behavior, simply override the container command or entrypoint to run `dockerd` directly (`... s390x/docker:dind dockerd ...` or `... --entrypoint dockerd s390x/docker:dind ...`).
