...
-	[`docker:1.10.0-rc1`](#docker1100-rc1)
-	[`docker:1.10-rc`](#docker110-rc)
-	[`docker:rc`](#dockerrc)
-	[`docker:1.10.0-rc1-dind`](#docker1100-rc1-dind)
-	[`docker:1.10-rc-dind`](#docker110-rc-dind)
-	[`docker:rc-dind`](#dockerrc-dind)
-	[`docker:1.10.0-rc1-git`](#docker1100-rc1-git)
...
```console
$ docker pull library/docker@sha256:8b255618c604ad481bf8a8bec657b2cd4c4a3e3e9c53cf6dab4cc331a1c00f09
```
...
## `docker:1.10.0-rc1-dind`

```console
$ docker pull library/docker@sha256:8ebcae129e727a0c84d1faf4a11bd1f8be3fe20e6f500873d6d722644f0ae910
```
...
## `docker:1.10.0-rc1-git`

```console
$ docker pull library/docker@sha256:661189134a73557ecf042a84e22b0460f01c2842f5b079804a4154a80196dbdc
```
