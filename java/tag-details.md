...
```console
$ docker pull library/java@sha256:b6edc68e808a35a61328e43a7b913be4cd555f25cd79336fd9a8821f662d0b35
```
...
```console
$ docker pull library/java@sha256:359cb7ec35665c4afb356646eb5d5f97447b0690aba547e9d00739c0d257646d
```
...
```console
$ docker pull library/java@sha256:81f4befb185e734002ed7bd683a21a0ea2fb99404e30bcf7c3527ac11906c4e9
```
...
```console
$ docker pull library/java@sha256:9c84ea23f18a0cc7e3810fa6e57da598e5e1e82905386170464a452e68e58d92
```
...
```console
$ docker pull library/java@sha256:6db08ad257c15383b90cd4856d56cfeed7fe8d4cd0191e5d8c5eb75c49a4018a
```
...
```console
$ docker pull library/java@sha256:89973753e18ede66e0273ba9dcc214831a75bba771c6a2dff6d3ecddd172fe5f
```
