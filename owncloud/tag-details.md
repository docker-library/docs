...
```console
$ docker pull library/owncloud@sha256:d782843183932ace9c800dc1cb3c6264964f24aacea4efaad50cfcc2f7388433
```
...
```console
$ docker pull library/owncloud@sha256:0dca3ecd73efd3ae1fb667839f2617ff5d28fa974b5bbcc74fc9c5ed5844ec42
```
...
```console
$ docker pull library/owncloud@sha256:0d903b7861a0f27cbe70aabed45c879403658fe9dafb30160cfe8a501a4bf4b6
```
...
```console
$ docker pull library/owncloud@sha256:f91db831e909d51b7490803399db018d83af49dbaca8c18373035a03842645ce
```
...
```console
$ docker pull library/owncloud@sha256:e9472802949121e585d545d087a67b9172ed6dd40cd5895b6821f06d47e0c9f2
```
...
```console
$ docker pull library/owncloud@sha256:d58ef25bce8bd09c16d4fd14dad43fc5d626f908f33d76a312f6661680b06749
```
...
```console
$ docker pull library/owncloud@sha256:134891168cb831dd7cd7170464f09d7b8829067adbd8eddb09517111a78d43c5
```
...
```console
$ docker pull library/owncloud@sha256:4f487095d99b72ebb94f66d960cecb6cd6c6464de099ddae78077dde817fc94f
```
...
```console
$ docker pull library/owncloud@sha256:df49e17c22f2f038c9a4321911599ec3b6a379cc2855449d818f67521a4b2592
```
...
```console
$ docker pull library/owncloud@sha256:bd21c0c08110b27428bd35ce65a1df8d430d047b6966073ab43726a65042e6ab
```
...
```console
$ docker pull library/owncloud@sha256:d778c8b392748406a2c87866912f170f8346eb1904512ea80604ead7b3b23d37
```
...
```console
$ docker pull library/owncloud@sha256:e14a3bac0a0c10ba848d34551760264d6639a5cfbbf393faad9cb6b279113668
```
