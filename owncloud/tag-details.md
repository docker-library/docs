...
```console
$ docker pull owncloud@sha256:5674655f77d64ef7d28474f0c6de10e653c9f59fba6a861deef44546000c26ee
```
...
-	Docker Version: 1.10.3
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **215.6 MB (215587103 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:667f2270027ee4db5ad51c710ebfcebd53e3b464b6ca16d65e1ea275f76ae259`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex 	&& pecl install APCu-4.0.10 	&& pecl install memcached-2.2.0 	&& pecl install redis-2.2.8 	&& docker-php-ext-enable apcu memcached redis
# Thu, 14 Jul 2016 03:39:23 GMT
ENV OWNCLOUD_VERSION=8.1.8
# Thu, 14 Jul 2016 03:39:23 GMT
VOLUME [/var/www/html]
# Thu, 14 Jul 2016 03:39:38 GMT
RUN curl -fsSL -o owncloud.tar.bz2 		"https://download.owncloud.org/community/owncloud-${OWNCLOUD_VERSION}.tar.bz2" 	&& curl -fsSL -o owncloud.tar.bz2.asc 		"https://download.owncloud.org/community/owncloud-${OWNCLOUD_VERSION}.tar.bz2.asc" 	&& export GNUPGHOME="$(mktemp -d)" 	&& gpg --keyserver ha.pool.sks-keyservers.net --recv-keys E3036906AD9F30807351FAC32D5D5E97F6978A26 	&& gpg --batch --verify owncloud.tar.bz2.asc owncloud.tar.bz2 	&& rm -r "$GNUPGHOME" owncloud.tar.bz2.asc 	&& tar -xjf owncloud.tar.bz2 -C /usr/src/ 	&& rm owncloud.tar.bz2
# Thu, 14 Jul 2016 03:39:39 GMT
COPY file:03fe90b626a097c27835e553f0b22ca55dc76d64d966006644b50609fffa4161 in /entrypoint.sh
# Thu, 14 Jul 2016 03:39:40 GMT
ENTRYPOINT &{["/entrypoint.sh"]}
# Thu, 14 Jul 2016 03:39:40 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e112214d7e01cde53e4148f0b3289f144d98b374e637c968fdb600c58c2ec9c6`  
		Last Modified: Thu, 14 Jul 2016 03:43:52 GMT  
		Size: 26.8 MB (26754544 bytes)
	-	`sha256:85535288a21731c586d63a6480e7c728fb7e6cf635ac0be7269b62bc0a214f76`  
		Last Modified: Thu, 14 Jul 2016 03:43:44 GMT  
		Size: 245.0 B
