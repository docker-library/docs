...
```console
$ docker pull library/owncloud@sha256:45a31dc966538c01920a22fd3d8aa160691d42fc9b327cd41fe7b894cad0fbe4
```
...
```console
$ docker pull library/owncloud@sha256:4edd5e57ca1a5eeab6b3ee66e446eaa1a80441108b082594f23e39700d7d7c2a
```
...
```console
$ docker pull library/owncloud@sha256:34b285d6a0d9b7dfd82d43ef9b1fd6bac76ce9fc3e06187580b2dab2b3d0e1c0
```
...
```console
$ docker pull library/owncloud@sha256:5f07544bf9536a6eabbcd2fc3d7d9dd894a261654dc942b458e5161979ab0c9f
```
...
```console
$ docker pull library/owncloud@sha256:b4c7815561cf3dc3dc54f4563878e2d348c633b0c78ecacc818a1b3dccd1ad54
```
...
```console
$ docker pull library/owncloud@sha256:2c07cfbcbd90581c3b2dd1abfb1281c083f59de2be2ce87747ed5799511ea548
```
...
```console
$ docker pull library/owncloud@sha256:242723284530d32c309eda8d2ec8c23d78e2ffab324c23d715cc0a0021eacaa0
```
...
```console
$ docker pull library/owncloud@sha256:8d8b404d4b3331bb4fa4758452ae033220a55b2ba17d08573642ca6d58222876
```
...
```console
$ docker pull library/owncloud@sha256:37a8464517d336fa5dbbb6696b3efd708a6e78427e7a564bb5e1455cd709aef6
```
...
```console
$ docker pull library/owncloud@sha256:3f7cc7211cd81e64ee688199853faac1cdcd55c68dabb51865df5b28d0f6099c
```
...
```console
$ docker pull library/owncloud@sha256:c0e2c5d76c0e04d0a51695646cb5840963bca9a2e36d70cdc6d8d033d1bc11c1
```
...
```console
$ docker pull library/owncloud@sha256:c6437cc893dc7f4a9c1f429a22be706aae38eea451980cf1fbbe473476bf93f7
```
...
```console
$ docker pull library/owncloud@sha256:594534b3ad8a1fe28aa0309b91fe1bb5578b1f4d222e2d98d6f5971a738f5155
```
...
```console
$ docker pull library/owncloud@sha256:6ea08d6ace880aac0c20f42ee479dbcc2e41cb40f87bb4de1ca0cd4eecddb106
```
...
```console
$ docker pull library/owncloud@sha256:095fbc6ab79e5f6a530c5756f429f7e52fe4c921dc6c5a499470f07660512021
```
