...
-	[`5.38.0-buster`, `5.38-buster`, `5-buster`, `buster`, `stable-buster`](https://github.com/perl/docker-perl/blob/d2d8aab002a6637612ed920fd6bacf21db9025a1/5.038.000-main-buster/Dockerfile)
...
-	[`5.38.0-slim-buster`, `5.38-slim-buster`, `5-slim-buster`, `slim-buster`, `stable-slim-buster`](https://github.com/perl/docker-perl/blob/d2d8aab002a6637612ed920fd6bacf21db9025a1/5.038.000-slim-buster/Dockerfile)
...
-	[`5.38.0-threaded-buster`, `5.38-threaded-buster`, `5-threaded-buster`, `threaded-buster`, `stable-threaded-buster`](https://github.com/perl/docker-perl/blob/d2d8aab002a6637612ed920fd6bacf21db9025a1/5.038.000-main,threaded-buster/Dockerfile)
...
-	[`5.38.0-slim-threaded-buster`, `5.38-slim-threaded-buster`, `5-slim-threaded-buster`, `slim-threaded-buster`, `stable-slim-threaded-buster`](https://github.com/perl/docker-perl/blob/d2d8aab002a6637612ed920fd6bacf21db9025a1/5.038.000-slim,threaded-buster/Dockerfile)
...
-	[`5.36.1-buster`, `5.36-buster`](https://github.com/perl/docker-perl/blob/d2d8aab002a6637612ed920fd6bacf21db9025a1/5.036.001-main-buster/Dockerfile)
...
-	[`5.36.1-slim-buster`, `5.36-slim-buster`](https://github.com/perl/docker-perl/blob/d2d8aab002a6637612ed920fd6bacf21db9025a1/5.036.001-slim-buster/Dockerfile)
...
-	[`5.36.1-threaded-buster`, `5.36-threaded-buster`](https://github.com/perl/docker-perl/blob/d2d8aab002a6637612ed920fd6bacf21db9025a1/5.036.001-main,threaded-buster/Dockerfile)
...
-	[`5.36.1-slim-threaded-bullseye`, `5.36-slim-threaded-bullseye`](https://github.com/perl/docker-perl/blob/d2d8aab002a6637612ed920fd6bacf21db9025a1/5.036.001-slim,threaded-bullseye/Dockerfile)
-	[`5.36.1-slim-threaded-buster`, `5.36-slim-threaded-buster`](https://github.com/perl/docker-perl/blob/d2d8aab002a6637612ed920fd6bacf21db9025a1/5.036.001-slim,threaded-buster/Dockerfile)
...
-	[`5.34.1-buster`, `5.34-buster`](https://github.com/perl/docker-perl/blob/d2d8aab002a6637612ed920fd6bacf21db9025a1/5.034.001-main-buster/Dockerfile)
...
-	[`5.34.1-slim-buster`, `5.34-slim-buster`](https://github.com/perl/docker-perl/blob/d2d8aab002a6637612ed920fd6bacf21db9025a1/5.034.001-slim-buster/Dockerfile)
...
-	[`5.34.1-threaded-buster`, `5.34-threaded-buster`](https://github.com/perl/docker-perl/blob/d2d8aab002a6637612ed920fd6bacf21db9025a1/5.034.001-main,threaded-buster/Dockerfile)
...
-	[`5.34.1-slim-threaded-buster`, `5.34-slim-threaded-buster`](https://github.com/perl/docker-perl/blob/d2d8aab002a6637612ed920fd6bacf21db9025a1/5.034.001-slim,threaded-buster/Dockerfile)
