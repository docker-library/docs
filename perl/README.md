...
If you have any questions about the image, please contact us through a [GitHub issue](https://github.com/docker-library/perl/issues) or in the IRC channel `#docker-library` on [Freenode](https://freenode.net).
