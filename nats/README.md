...
-	[`2.12.8-alpine3.22`, `2.12-alpine3.22`, `2-alpine3.22`, `alpine3.22`, `2.12.8-alpine`, `2.12-alpine`, `2-alpine`, `alpine`](https://github.com/nats-io/nats-docker/blob/e6bf552cc60f59021c14158a86e014f8bd8997f9/2.12.x/alpine3.22/Dockerfile)

-	[`2.12.8-scratch`, `2.12-scratch`, `2-scratch`, `scratch`, `2.12.8-linux`, `2.12-linux`, `2-linux`, `linux`](https://github.com/nats-io/nats-docker/blob/e6bf552cc60f59021c14158a86e014f8bd8997f9/2.12.x/scratch/Dockerfile)

-	[`2.12.8-windowsservercore-ltsc2022`, `2.12-windowsservercore-ltsc2022`, `2-windowsservercore-ltsc2022`, `windowsservercore-ltsc2022`](https://github.com/nats-io/nats-docker/blob/e6bf552cc60f59021c14158a86e014f8bd8997f9/2.12.x/windowsservercore-ltsc2022/Dockerfile)

-	[`2.12.8-nanoserver-ltsc2022`, `2.12-nanoserver-ltsc2022`, `2-nanoserver-ltsc2022`, `nanoserver-ltsc2022`](https://github.com/nats-io/nats-docker/blob/e6bf552cc60f59021c14158a86e014f8bd8997f9/2.12.x/nanoserver-ltsc2022/Dockerfile)

-	[`2.11.17-alpine3.22`, `2.11-alpine3.22`, `2.11.17-alpine`, `2.11-alpine`](https://github.com/nats-io/nats-docker/blob/e6bf552cc60f59021c14158a86e014f8bd8997f9/2.11.x/alpine3.22/Dockerfile)

-	[`2.11.17-scratch`, `2.11-scratch`, `2.11.17-linux`, `2.11-linux`](https://github.com/nats-io/nats-docker/blob/e6bf552cc60f59021c14158a86e014f8bd8997f9/2.11.x/scratch/Dockerfile)

-	[`2.11.17-windowsservercore-ltsc2022`, `2.11-windowsservercore-ltsc2022`](https://github.com/nats-io/nats-docker/blob/e6bf552cc60f59021c14158a86e014f8bd8997f9/2.11.x/windowsservercore-ltsc2022/Dockerfile)

-	[`2.11.17-nanoserver-ltsc2022`, `2.11-nanoserver-ltsc2022`](https://github.com/nats-io/nats-docker/blob/e6bf552cc60f59021c14158a86e014f8bd8997f9/2.11.x/nanoserver-ltsc2022/Dockerfile)

## Shared Tags

-	`2.12.8`, `2.12`, `2`, `latest`:

	-	[`2.12.8-scratch`](https://github.com/nats-io/nats-docker/blob/e6bf552cc60f59021c14158a86e014f8bd8997f9/2.12.x/scratch/Dockerfile)
	-	[`2.12.8-nanoserver-ltsc2022`](https://github.com/nats-io/nats-docker/blob/e6bf552cc60f59021c14158a86e014f8bd8997f9/2.12.x/nanoserver-ltsc2022/Dockerfile)

-	`2.12.8-windowsservercore`, `2.12-windowsservercore`, `2-windowsservercore`, `windowsservercore`:

	-	[`2.12.8-windowsservercore-ltsc2022`](https://github.com/nats-io/nats-docker/blob/e6bf552cc60f59021c14158a86e014f8bd8997f9/2.12.x/windowsservercore-ltsc2022/Dockerfile)

-	`2.12.8-nanoserver`, `2.12-nanoserver`, `2-nanoserver`, `nanoserver`:

	-	[`2.12.8-nanoserver-ltsc2022`](https://github.com/nats-io/nats-docker/blob/e6bf552cc60f59021c14158a86e014f8bd8997f9/2.12.x/nanoserver-ltsc2022/Dockerfile)

-	`2.11.17`, `2.11`:

	-	[`2.11.17-scratch`](https://github.com/nats-io/nats-docker/blob/e6bf552cc60f59021c14158a86e014f8bd8997f9/2.11.x/scratch/Dockerfile)
	-	[`2.11.17-nanoserver-ltsc2022`](https://github.com/nats-io/nats-docker/blob/e6bf552cc60f59021c14158a86e014f8bd8997f9/2.11.x/nanoserver-ltsc2022/Dockerfile)

-	`2.11.17-windowsservercore`, `2.11-windowsservercore`:

	-	[`2.11.17-windowsservercore-ltsc2022`](https://github.com/nats-io/nats-docker/blob/e6bf552cc60f59021c14158a86e014f8bd8997f9/2.11.x/windowsservercore-ltsc2022/Dockerfile)
