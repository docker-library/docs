...
-	[`2.2.3-alpine3.13`, `2.2-alpine3.13`, `2-alpine3.13`, `alpine3.13`, `2.2.3-alpine`, `2.2-alpine`, `2-alpine`, `alpine`](https://github.com/nats-io/nats-docker/blob/d265a2528b72bb991bfeb437a341156abfa12d4a/2.2.3/alpine3.13/Dockerfile)
-	[`2.2.3-scratch`, `2.2-scratch`, `2-scratch`, `scratch`, `2.2.3-linux`, `2.2-linux`, `2-linux`, `linux`](https://github.com/nats-io/nats-docker/blob/d265a2528b72bb991bfeb437a341156abfa12d4a/2.2.3/scratch/Dockerfile)
-	[`2.2.3-windowsservercore-1809`, `2.2-windowsservercore-1809`, `2-windowsservercore-1809`, `windowsservercore-1809`](https://github.com/nats-io/nats-docker/blob/d265a2528b72bb991bfeb437a341156abfa12d4a/2.2.3/windowsservercore-1809/Dockerfile)
-	[`2.2.3-nanoserver-1809`, `2.2-nanoserver-1809`, `2-nanoserver-1809`, `nanoserver-1809`](https://github.com/nats-io/nats-docker/blob/d265a2528b72bb991bfeb437a341156abfa12d4a/2.2.3/nanoserver-1809/Dockerfile)
-	[`2.2.3-windowsservercore-ltsc2016`, `2.2-windowsservercore-ltsc2016`, `2-windowsservercore-ltsc2016`, `windowsservercore-ltsc2016`](https://github.com/nats-io/nats-docker/blob/d265a2528b72bb991bfeb437a341156abfa12d4a/2.2.3/windowsservercore-ltsc2016/Dockerfile)

## Shared Tags

-	`2.2.3`, `2.2`, `2`, `latest`:
	-	[`2.2.3-scratch`](https://github.com/nats-io/nats-docker/blob/d265a2528b72bb991bfeb437a341156abfa12d4a/2.2.3/scratch/Dockerfile)
	-	[`2.2.3-nanoserver-1809`](https://github.com/nats-io/nats-docker/blob/d265a2528b72bb991bfeb437a341156abfa12d4a/2.2.3/nanoserver-1809/Dockerfile)
-	`2.2.3-windowsservercore`, `2.2-windowsservercore`, `2-windowsservercore`, `windowsservercore`:
	-	[`2.2.3-windowsservercore-1809`](https://github.com/nats-io/nats-docker/blob/d265a2528b72bb991bfeb437a341156abfa12d4a/2.2.3/windowsservercore-1809/Dockerfile)
	-	[`2.2.3-windowsservercore-ltsc2016`](https://github.com/nats-io/nats-docker/blob/d265a2528b72bb991bfeb437a341156abfa12d4a/2.2.3/windowsservercore-ltsc2016/Dockerfile)
-	`2.2.3-nanoserver`, `2.2-nanoserver`, `2-nanoserver`, `nanoserver`:
	-	[`2.2.3-nanoserver-1809`](https://github.com/nats-io/nats-docker/blob/d265a2528b72bb991bfeb437a341156abfa12d4a/2.2.3/nanoserver-1809/Dockerfile)
