...
-	**Where to file issues**:  
	[https://github.com/monicahq/docker/issues](https://github.com/monicahq/docker/issues?q=is:issue+is:pr)
...
where `monica` is the name of the service in your `compose.yaml` file.
...
The `riscv64/monica` images come in many flavors, each designed for a specific use case.

## `riscv64/monica:<version>`

This is the defacto image. If you are unsure about what your needs are, you probably want to use this one. It is designed to be used both as a throw away container (mount your source code and start the container to start your app), as well as the base to build other images off of.

## `riscv64/monica:<version>-alpine`
