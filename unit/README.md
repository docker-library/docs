...
[![arm32v5/unit build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/unit.svg?label=arm32v5/unit%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm32v5/job/unit/)
