...
-	**Supported architectures**: ([more info](https://github.com/docker-library/official-images#architectures-other-than-amd64))  
	[`amd64`](https://hub.docker.com/r/amd64/centos/), [`i386`](https://hub.docker.com/r/i386/centos/), [`arm64v8`](https://hub.docker.com/r/arm64v8/centos/), [`ppc64le`](https://hub.docker.com/r/ppc64le/centos/)
