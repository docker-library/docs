...
First you need to run MySQL or MariaDB server in Docker, and this image needs to be linked to the running database container:
...
This will run phpMyAdmin with arbitrary server option - allowing you to specify any MySQL/MariaDB server on the login page.
