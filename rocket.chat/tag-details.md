...
-	[`rocket.chat:0.15.0`](#rocketchat0150)
-	[`rocket.chat:0.15`](#rocketchat015)
...
```console
$ docker pull library/rocket.chat@sha256:34df6115e2767aee91e2c16bf0c7a821499514c0effab87cd53a392d1a777b31
```
...
```console
$ docker pull library/rocket.chat@sha256:f53b74bb67bd839b88c3698683632be6f924d4a38c4d08eca64a8ca0aea54666
```
