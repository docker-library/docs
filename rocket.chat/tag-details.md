...
```console
$ docker pull library/rocket.chat@sha256:4e1eeee66522d81b043aad6e929e0d65f7c72d832d9d1606297d155281505127
```
...
```console
$ docker pull library/rocket.chat@sha256:4df97cc4ebcaecb0f7bffc1d6976dbfb048776163b1f7bcbdea40af7cb7a3715
```
