...
-	[`kernel`](https://github.com/WASdev/ci.docker/blob/4de6970d7654cd41f27a8806f5cd1a609471151e/ga/latest/kernel/Dockerfile.ubuntu.ibmjava8)
-	[`kernel-java11-openj9`](https://github.com/WASdev/ci.docker/blob/4de6970d7654cd41f27a8806f5cd1a609471151e/ga/latest/kernel/Dockerfile.ubuntu.openjdk11)
-	[`full`, `latest`](https://github.com/WASdev/ci.docker/blob/4de6970d7654cd41f27a8806f5cd1a609471151e/ga/latest/full/Dockerfile.ubuntu.ibmjava8)
-	[`full-java11-openj9`](https://github.com/WASdev/ci.docker/blob/4de6970d7654cd41f27a8806f5cd1a609471151e/ga/latest/full/Dockerfile.ubuntu.openjdk11)
-	[`21.0.0.10-kernel-java8-ibmjava`](https://github.com/WASdev/ci.docker/blob/4de6970d7654cd41f27a8806f5cd1a609471151e/ga/21.0.0.10/kernel/Dockerfile.ubuntu.ibmjava8)
-	[`21.0.0.10-kernel-java11-openj9`](https://github.com/WASdev/ci.docker/blob/4de6970d7654cd41f27a8806f5cd1a609471151e/ga/21.0.0.10/kernel/Dockerfile.ubuntu.openjdk11)
-	[`21.0.0.10-full-java8-ibmjava`](https://github.com/WASdev/ci.docker/blob/4de6970d7654cd41f27a8806f5cd1a609471151e/ga/21.0.0.10/full/Dockerfile.ubuntu.ibmjava8)
-	[`21.0.0.10-full-java11-openj9`](https://github.com/WASdev/ci.docker/blob/4de6970d7654cd41f27a8806f5cd1a609471151e/ga/21.0.0.10/full/Dockerfile.ubuntu.openjdk11)
-	[`21.0.0.9-kernel-java8-ibmjava`](https://github.com/WASdev/ci.docker/blob/4de6970d7654cd41f27a8806f5cd1a609471151e/ga/21.0.0.9/kernel/Dockerfile.ubuntu.ibmjava8)
-	[`21.0.0.9-kernel-java11-openj9`](https://github.com/WASdev/ci.docker/blob/4de6970d7654cd41f27a8806f5cd1a609471151e/ga/21.0.0.9/kernel/Dockerfile.ubuntu.openjdk11)
-	[`21.0.0.9-full-java8-ibmjava`](https://github.com/WASdev/ci.docker/blob/4de6970d7654cd41f27a8806f5cd1a609471151e/ga/21.0.0.9/full/Dockerfile.ubuntu.ibmjava8)
-	[`21.0.0.9-full-java11-openj9`](https://github.com/WASdev/ci.docker/blob/4de6970d7654cd41f27a8806f5cd1a609471151e/ga/21.0.0.9/full/Dockerfile.ubuntu.openjdk11)
-	[`21.0.0.6-kernel-java8-ibmjava`](https://github.com/WASdev/ci.docker/blob/4de6970d7654cd41f27a8806f5cd1a609471151e/ga/21.0.0.6/kernel/Dockerfile.ubuntu.ibmjava8)
-	[`21.0.0.6-kernel-java11-openj9`](https://github.com/WASdev/ci.docker/blob/4de6970d7654cd41f27a8806f5cd1a609471151e/ga/21.0.0.6/kernel/Dockerfile.ubuntu.openjdk11)
-	[`21.0.0.6-full-java8-ibmjava`](https://github.com/WASdev/ci.docker/blob/4de6970d7654cd41f27a8806f5cd1a609471151e/ga/21.0.0.6/full/Dockerfile.ubuntu.ibmjava8)
-	[`21.0.0.6-full-java11-openj9`](https://github.com/WASdev/ci.docker/blob/4de6970d7654cd41f27a8806f5cd1a609471151e/ga/21.0.0.6/full/Dockerfile.ubuntu.openjdk11)
