...
**Note:** this is the "per-architecture" repository for the `s390x` builds of [the `spark` official image](https://hub.docker.com/_/spark) -- for more information, see ["Architectures other than amd64?" in the official images documentation](https://github.com/docker-library/official-images#architectures-other-than-amd64) and ["An image's source changed in Git, now what?" in the official images FAQ](https://github.com/docker-library/faq#an-images-source-changed-in-git-now-what).
...
[![s390x/spark build status badge](https://img.shields.io/jenkins/s/https/doi-janky.infosiftr.net/job/multiarch/job/s390x/job/spark.svg?label=s390x/spark%20%20build%20job)](https://doi-janky.infosiftr.net/job/multiarch/job/s390x/job/spark/)
...
```console
docker run -it s390x/spark /opt/spark/bin/spark-shell
```
...
```console
docker run -it s390x/spark:python3 /opt/spark/bin/pyspark
```
...
```console
docker run -it s390x/spark:r /opt/spark/bin/sparkR
```
