...
```console
$ docker run --name some-mariadb -p 3306:3306 mips64le/mariadb:latest
```
...
```console
$ docker run -it --network some-network --rm mips64le/mariadb mariadb -h some-mariadb -u example-user
```
