...
```console
$ docker run --name some-mariadb -v /my/custom:/etc/mysql/conf.d --rm arm32v5/mariadb:latest my_print_defaults --mariadbd
```
...
```console
$ docker run --rm arm32v5/mariadb:latest --verbose --help
```
