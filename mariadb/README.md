...
```console
$ docker run --name some-mariadb -v /my/custom:/etc/mysql/conf.d --rm arm64v8/mariadb:latest my_print_defaults --mariadbd
```
...
```console
$ docker run --rm arm64v8/mariadb:latest --verbose --help
```
