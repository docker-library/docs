...
```console
$ docker run --name some-mariadb -v /my/custom:/etc/mysql/conf.d --rm s390x/mariadb:latest my_print_defaults --mariadbd
```
...
```console
$ docker run --rm s390x/mariadb:latest --verbose --help
```
