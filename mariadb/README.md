...
```console
$ docker run --name some-mariadb -v /my/custom:/etc/mysql/conf.d --rm winamd64/mariadb:latest my_print_defaults --mariadbd
```
...
```console
$ docker run --rm winamd64/mariadb:latest --verbose --help
```
