...
-	[`3.9.1-php5.6-apache`, `3.9-php5.6-apache`, `3-php5.6-apache`, `php5.6-apache`, `3.9.1-php5.6`, `3.9-php5.6`, `3-php5.6`, `php5.6` (*php5.6/apache/Dockerfile*)](https://github.com/joomla/docker-joomla/blob/392d635f5973e30501580deda634fb710e710e47/php5.6/apache/Dockerfile)
-	[`3.9.1-php5.6-fpm`, `3.9-php5.6-fpm`, `3-php5.6-fpm`, `php5.6-fpm` (*php5.6/fpm/Dockerfile*)](https://github.com/joomla/docker-joomla/blob/392d635f5973e30501580deda634fb710e710e47/php5.6/fpm/Dockerfile)
-	[`3.9.1-php5.6-fpm-alpine`, `3.9-php5.6-fpm-alpine`, `3-php5.6-fpm-alpine`, `php5.6-fpm-alpine` (*php5.6/fpm-alpine/Dockerfile*)](https://github.com/joomla/docker-joomla/blob/392d635f5973e30501580deda634fb710e710e47/php5.6/fpm-alpine/Dockerfile)
-	[`3.9.1-apache`, `3.9-apache`, `3-apache`, `apache`, `3.9.1`, `3.9`, `3`, `latest`, `3.9.1-php7.1-apache`, `3.9-php7.1-apache`, `3-php7.1-apache`, `php7.1-apache`, `3.9.1-php7.1`, `3.9-php7.1`, `3-php7.1`, `php7.1` (*php7.1/apache/Dockerfile*)](https://github.com/joomla/docker-joomla/blob/ce437363431d0a59d819b4af49a5aa1ffdf6e319/php7.1/apache/Dockerfile)
-	[`3.9.1-fpm`, `3.9-fpm`, `3-fpm`, `fpm`, `3.9.1-php7.1-fpm`, `3.9-php7.1-fpm`, `3-php7.1-fpm`, `php7.1-fpm` (*php7.1/fpm/Dockerfile*)](https://github.com/joomla/docker-joomla/blob/ce437363431d0a59d819b4af49a5aa1ffdf6e319/php7.1/fpm/Dockerfile)
-	[`3.9.1-fpm-alpine`, `3.9-fpm-alpine`, `3-fpm-alpine`, `fpm-alpine`, `3.9.1-php7.1-fpm-alpine`, `3.9-php7.1-fpm-alpine`, `3-php7.1-fpm-alpine`, `php7.1-fpm-alpine` (*php7.1/fpm-alpine/Dockerfile*)](https://github.com/joomla/docker-joomla/blob/ce437363431d0a59d819b4af49a5aa1ffdf6e319/php7.1/fpm-alpine/Dockerfile)
-	[`3.9.1-php7.2-apache`, `3.9-php7.2-apache`, `3-php7.2-apache`, `php7.2-apache`, `3.9.1-php7.2`, `3.9-php7.2`, `3-php7.2`, `php7.2` (*php7.2/apache/Dockerfile*)](https://github.com/joomla/docker-joomla/blob/ce437363431d0a59d819b4af49a5aa1ffdf6e319/php7.2/apache/Dockerfile)
-	[`3.9.1-php7.2-fpm`, `3.9-php7.2-fpm`, `3-php7.2-fpm`, `php7.2-fpm` (*php7.2/fpm/Dockerfile*)](https://github.com/joomla/docker-joomla/blob/ce437363431d0a59d819b4af49a5aa1ffdf6e319/php7.2/fpm/Dockerfile)
-	[`3.9.1-php7.2-fpm-alpine`, `3.9-php7.2-fpm-alpine`, `3-php7.2-fpm-alpine`, `php7.2-fpm-alpine` (*php7.2/fpm-alpine/Dockerfile*)](https://github.com/joomla/docker-joomla/blob/ce437363431d0a59d819b4af49a5aa1ffdf6e319/php7.2/fpm-alpine/Dockerfile)
-	[`3.9.1-php7.3-apache`, `3.9-php7.3-apache`, `3-php7.3-apache`, `php7.3-apache`, `3.9.1-php7.3`, `3.9-php7.3`, `3-php7.3`, `php7.3` (*php7.3/apache/Dockerfile*)](https://github.com/joomla/docker-joomla/blob/ce437363431d0a59d819b4af49a5aa1ffdf6e319/php7.3/apache/Dockerfile)
-	[`3.9.1-php7.3-fpm`, `3.9-php7.3-fpm`, `3-php7.3-fpm`, `php7.3-fpm` (*php7.3/fpm/Dockerfile*)](https://github.com/joomla/docker-joomla/blob/ce437363431d0a59d819b4af49a5aa1ffdf6e319/php7.3/fpm/Dockerfile)
-	[`3.9.1-php7.3-fpm-alpine`, `3.9-php7.3-fpm-alpine`, `3-php7.3-fpm-alpine`, `php7.3-fpm-alpine` (*php7.3/fpm-alpine/Dockerfile*)](https://github.com/joomla/docker-joomla/blob/ce437363431d0a59d819b4af49a5aa1ffdf6e319/php7.3/fpm-alpine/Dockerfile)
