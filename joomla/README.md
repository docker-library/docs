...
```console
$ docker run --name some-joomla --network some-network -d winamd64/joomla
```
...
```console
$ docker run --name some-joomla --network some-network -p 8080:80 -d winamd64/joomla
```
...
$ docker run --name some-joomla --network some-network -e JOOMLA_DB_HOST=10.1.2.3:3306 \
    -e JOOMLA_DB_USER=... -e JOOMLA_DB_PASSWORD=... -d winamd64/joomla
```
