...
```console
$ docker run -v $(pwd)/certs:/certificates/ -e USE_SYSTEM_CA_CERTS=1 i386/eclipse-temurin:25
```
...
COPY --from=i386/eclipse-temurin:25 $JAVA_HOME $JAVA_HOME
...
FROM i386/eclipse-temurin:25 as jre-build
