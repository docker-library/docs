...
-	[`1-bullseye`, `1.94-bullseye`, `1.94.0-bullseye`, `bullseye`](https://github.com/rust-lang/docker-rust/blob/4132ed1e071f80134ef880bbac42ebc430e946ea/stable/bullseye/Dockerfile)

-	[`1-slim-bullseye`, `1.94-slim-bullseye`, `1.94.0-slim-bullseye`, `slim-bullseye`](https://github.com/rust-lang/docker-rust/blob/4132ed1e071f80134ef880bbac42ebc430e946ea/stable/bullseye/slim/Dockerfile)

-	[`1-bookworm`, `1.94-bookworm`, `1.94.0-bookworm`, `bookworm`](https://github.com/rust-lang/docker-rust/blob/4132ed1e071f80134ef880bbac42ebc430e946ea/stable/bookworm/Dockerfile)

-	[`1-slim-bookworm`, `1.94-slim-bookworm`, `1.94.0-slim-bookworm`, `slim-bookworm`](https://github.com/rust-lang/docker-rust/blob/4132ed1e071f80134ef880bbac42ebc430e946ea/stable/bookworm/slim/Dockerfile)

-	[`1-trixie`, `1.94-trixie`, `1.94.0-trixie`, `trixie`, `1`, `1.94`, `1.94.0`, `latest`](https://github.com/rust-lang/docker-rust/blob/4132ed1e071f80134ef880bbac42ebc430e946ea/stable/trixie/Dockerfile)

-	[`1-slim-trixie`, `1.94-slim-trixie`, `1.94.0-slim-trixie`, `slim-trixie`, `1-slim`, `1.94-slim`, `1.94.0-slim`, `slim`](https://github.com/rust-lang/docker-rust/blob/4132ed1e071f80134ef880bbac42ebc430e946ea/stable/trixie/slim/Dockerfile)

-	[`1-alpine3.20`, `1.94-alpine3.20`, `1.94.0-alpine3.20`, `alpine3.20`](https://github.com/rust-lang/docker-rust/blob/4132ed1e071f80134ef880bbac42ebc430e946ea/stable/alpine3.20/Dockerfile)

-	[`1-alpine3.21`, `1.94-alpine3.21`, `1.94.0-alpine3.21`, `alpine3.21`](https://github.com/rust-lang/docker-rust/blob/4132ed1e071f80134ef880bbac42ebc430e946ea/stable/alpine3.21/Dockerfile)

-	[`1-alpine3.22`, `1.94-alpine3.22`, `1.94.0-alpine3.22`, `alpine3.22`](https://github.com/rust-lang/docker-rust/blob/4132ed1e071f80134ef880bbac42ebc430e946ea/stable/alpine3.22/Dockerfile)

-	[`1-alpine3.23`, `1.94-alpine3.23`, `1.94.0-alpine3.23`, `alpine3.23`, `1-alpine`, `1.94-alpine`, `1.94.0-alpine`, `alpine`](https://github.com/rust-lang/docker-rust/blob/4132ed1e071f80134ef880bbac42ebc430e946ea/stable/alpine3.23/Dockerfile)
