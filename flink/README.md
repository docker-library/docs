...
-	[`1.5.2-hadoop24-scala_2.11-alpine`, `1.5.2-hadoop24-alpine`, `1.5-hadoop24-alpine`, `hadoop24-alpine` (*1.5/hadoop24-scala_2.11-alpine/Dockerfile*)](https://github.com/docker-flink/docker-flink/blob/3ec60c89d9c6dc0b82770861f40e40517cc01ae5/1.5/hadoop24-scala_2.11-alpine/Dockerfile)
-	[`1.5.2-hadoop26-scala_2.11-alpine`, `1.5.2-hadoop26-alpine`, `1.5-hadoop26-alpine`, `hadoop26-alpine` (*1.5/hadoop26-scala_2.11-alpine/Dockerfile*)](https://github.com/docker-flink/docker-flink/blob/3ec60c89d9c6dc0b82770861f40e40517cc01ae5/1.5/hadoop26-scala_2.11-alpine/Dockerfile)
-	[`1.5.2-hadoop27-scala_2.11-alpine`, `1.5.2-hadoop27-alpine`, `1.5-hadoop27-alpine`, `hadoop27-alpine` (*1.5/hadoop27-scala_2.11-alpine/Dockerfile*)](https://github.com/docker-flink/docker-flink/blob/3ec60c89d9c6dc0b82770861f40e40517cc01ae5/1.5/hadoop27-scala_2.11-alpine/Dockerfile)
-	[`1.5.2-hadoop28-scala_2.11-alpine`, `1.5.2-hadoop28-alpine`, `1.5-hadoop28-alpine`, `hadoop28-alpine` (*1.5/hadoop28-scala_2.11-alpine/Dockerfile*)](https://github.com/docker-flink/docker-flink/blob/3ec60c89d9c6dc0b82770861f40e40517cc01ae5/1.5/hadoop28-scala_2.11-alpine/Dockerfile)
-	[`1.5.2-scala_2.11-alpine`, `1.5-scala_2.11-alpine`, `scala_2.11-alpine`, `1.5.2-alpine`, `1.5-alpine`, `alpine` (*1.5/scala_2.11-alpine/Dockerfile*)](https://github.com/docker-flink/docker-flink/blob/3ec60c89d9c6dc0b82770861f40e40517cc01ae5/1.5/scala_2.11-alpine/Dockerfile)
