...
-	`i386/influxdb:3-core` - **Latest InfluxDB OSS** (InfluxDB 3 Core)
-	`i386/influxdb:2` - Previous generation OSS (InfluxDB v2)
-	`i386/influxdb:1.11` - InfluxDB v1
...
-	`i386/influxdb:1.11-data` - Data nodes for clustering
-	`i386/influxdb:1.11-meta` - Meta nodes for cluster coordination (port 8091)
